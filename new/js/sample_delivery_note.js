...
function newent() {
    document.getElementById('sampletransnote_txt').value = "";
    document.getElementById('aod_txt').value = "";
...
function getdt() {
    ...
    var url = "sample_delivery_note_data.php";
...
function assign_dt() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        document.getElementById('sampletransnote_txt').value = XMLAddress1[0].childNodes[0].nodeValue;
...
function save_inv() {
    ...
    document.getElementById('msg_box').innerHTML = "";
//    if (document.getElementById('aod_txt').value == "") {
//        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Job Delevery No. Not Enterd</span></div>";
//        return false;
//    }
    ...
    url = url + "&sampletransnote_txt=" + document.getElementById('sampletransnote_txt').value;
    url = url + "&aod_txt=" + document.getElementById('aod_txt').value;
...
function edit() {
    ...
    if (document.getElementById('aod_txt').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>AOD No. Not Enterd</span></div>";
        return false;
    }
