    ...
    <form name="form1" id="form1">            
        <table width="100%" border="0"  class=\"form-matrix-table\">
            <tr>
                ...
                <td width="10%"><a href="search_purord_3.php?stname=ord" onclick="NewWindow(this.href, 'mywin', '800', '700', 'yes', 'center');return false" onfocus="this.blur()">
            ...
            <tr>
                ...
                <td><a href="search_purord_1_2.php?stname=req" onclick="NewWindow(this.href, 'mywin', '800', '700', 'yes', 'center');return false" onfocus="this.blur()">
                    <input type="button" name="searchinv" id="searchinv" value="..." class="btn_purchase1" />
                </a></td>
            </tr>
            <tr>
