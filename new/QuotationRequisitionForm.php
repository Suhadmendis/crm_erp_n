...
<html lang="en">
    <head>
        <title>Quotation Requisition Form</title>
...
<!--                            <input type="text" name="q" class="form-control" placeholder="Search...">
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>Quotation Requisition Form</b></h3>
                        </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group-sm">
                                        ...
                                        <label class="col-sm-1 input-sm " style="text-align: left; " for="invno"></label>
                                        <label class="col-sm-1 input-sm " style="text-align: left;" for="invno">Date</label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group-sm" >
                                        <label class="col-sm-1 input-sm labelColour" style="text-align: left;" for="invno">DRF NO</label>
                                        <div class="col-sm-1">
                                            <input type="text" placeholder="DRF No" id="DRFTxt" class="form-control  input-sm labelColour">
                                        </div>  
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="Required By " id="requiredByTxt" class="form-control dt input-sm labelColour">
                                        </div> 
    ...
    <!--                                            <input type="button" class="btn btn-default "  id="searchcust" name="searchcust">-->
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-1 input-sm labelColour" style="text-align: left;" for="invno">Atttention</label>
                                        <div class="col-sm-5">
                                            <input type="text" placeholder="Attention " id="attTxt" class="form-control  input-sm labelColour">
                                        </div>
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-1 input-sm labelColour" style="text-align: left;" for="invno">CC</label>
                                        <div class="col-sm-5">
                                            <input type="text" placeholder="CC " id="ccTxt" class="form-control  input-sm labelColour">
                                        </div>
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-1 input-sm labelColour" style="text-align: left;" for="invno">Payment Term</label>
                                        <div class="col-sm-5">
                                            <input type="text" placeholder="Payment Term " id="payTxt" class="form-control  input-sm labelColour">
                                        </div>
                                    ...
                                    <div class="form-group-sm">
                                        ...
                                        <div class="col-sm-1" style="margin-top: -20px;">
                                            <a onfocus="this.blur()" onclick="NewWindow('Search_Brand_mas.php', 'mywin', '800', '700', 'yes', 'center');
                                                    return false" href="">
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-1 input-sm labelColour" style="text-align: left;" for="invno">Remarks</label>

                                        <div class="col-sm-5">
                                            <input type="text" placeholder="Remarks" id="remarksTxt" class="form-control  input-sm labelColour">
                                        </div>
                                    </div>
                                    <div class="form-group" ></div>
                ...
                <script src="js/QuotationReqisitionForm.js"></script>
