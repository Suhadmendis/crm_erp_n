...
<div class="container">
    ...
    <table border="0" class="table table-bordered">
        ...
        <tr>
            ...
            <td width="122" ><input type="text" size="20" name="cusno1" id="cusno1" value=""  class="form-control" tabindex="1" onkeyup="<?php echo "update_list('$stname')"; ?>" /></td>
            <td width="481" ><input type="text" size="70" name="customername" id="customername" value=""  class="form-control" onkeyup="<?php echo "update_list('$stname')"; ?>"/></td>
    </table>
    <div id="filt_table">  <table class="table table-bordered">
            ...
            $sql = "select REF_NO, dele_no, SDATE,C_CODE,CUS_NAME,GRAND_TOT from s_salma where ";
            if($stname == ""){
                    $sql .= "trn_type ='INV'";
