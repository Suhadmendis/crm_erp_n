...
function setsvat()
{
	if (document.getElementById("chksvat").checked==true){
		document.getElementById("txt_svatref").disabled = false;
	} else if (document.getElementById("chksvat").checked==false){
		document.getElementById("txt_svatref").disabled = true;
	}
}
...
{   
	...
	if (document.getElementById('txtrefno').value==""){
		...
		if( document.getElementById('lock').innerHTML==""){
			...
			url=url+"&txt_svatref="+document.getElementById('txt_svatref').value;
