        ...
        <div class="container">
            ...
            <div id="filt_table">  <table class="table table-bordered">
                    ...
                    foreach ($conn->query($sql) as $row) {
                        ...
                        echo "<tr>               
                              <td onclick=\"custno('" . $row['REF_NO'] . "', '$stname');\">" . $row['REF_NO'] . "</a></td>
                              <td onclick=\"custno('" . $row['REF_NO'] . "', '$stname');\">" . $row['cus_name'] . "</a></td>
                              <td onclick=\"custno('" . $row['REF_NO'] . "', '$stname');\">" . $row['SDATE'] . "</a></td>
                              </tr>";
                    }
