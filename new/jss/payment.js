...
function showarmyresultbal() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
		...
		document.getElementById('txt_rate1').disabled = true;
...
function new_inv() {
	...
	document.getElementById('txt_rate1').disabled = false;
...
function amoword_cal() {
    ...
    M_INPUT = document.getElementById('subtot').value;
    ...
    TXT_DEBTOT = document.getElementById('subtot').value;
...
function update_list_cbal(stname) {
    ...
    var url = "payment_data.php";
    url = url + "?Command=" + "update_list_cbal";
    url = url + "&refno=" + document.getElementById('cusno').value;
    url = url + "&cusname=" + document.getElementById('customername').value;
    url = url + "&stname=" + stname;
