...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Advance Payment Details</div>
                                               	 </legend>             
...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td width="14%"><input type="text" name="crnno" id="crnno" value="" class="text_purchase" onkeypress="keyset('searchcust',event);" onfocus="got_focus('invno');"  onblur="lost_focus('invno');"  />
      <a href="serach_crn.php?stname=adp" onClick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onFocus="this.blur()">
  ...
  <tr>
    ...
    <td><input type="text" size="15" name="txtChqNo" id="txtChqNo" value="" onkeypress="keyset('creditlimit',event);" class="text_purchase3"/></td>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" size="15" name="txtChqDate" id="txtChqDate" value="<?php echo date("Y-m-d");?>" onfocus="load_calader('txtChqDate');" class="text_purchase3"/></td>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td><input type="text"  class="label_purchase" value="Branch" disabled="disabled"/></td>
    <td><input type="text" size="15" name="txtChqBranch" id="txtChqBranch" value="" onkeypress="keyset('creditlimit',event);" class="text_purchase3"/></td>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td><input type="text"  class="label_purchase" value="Credit" disabled="disabled"/></td>
    <td><input type="text"  class="text_purchase3" name="accno2" id="accno2" size="10" value="2029" disabled=""/></td>
    <td><input type="text"  class="text_purchase3" size="10" id="acc_name2" name="acc_name2" value="Advance From Customers" disabled=""/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
