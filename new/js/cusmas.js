...
function passcusresult_quot()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        if ((stname != "costing")) {
            ...
            }else if (stname === "iso_mr"){
                
                 XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("id");
                opener.document.form1.customer_m.value = XMLAddress1[0].childNodes[0].nodeValue;
                
                  XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_customername");
                opener.document.form1.customer_f.value = XMLAddress1[0].childNodes[0].nodeValue;
            }else if (stname === "job_ord"){
