...
function newent() {
    ...
    document.getElementById('customer_m').value = "";
    document.getElementById('customer_f').value = "";
...
function getdt() {
    ...
    var url = "material_requirment_data.php";
...
//        }
    ...
    url = url + "&customer_m=" + document.getElementById('customer_m').value;
    url = url + "&customer_f=" + document.getElementById('customer_f').value;
    url = url + "&date=" + document.getElementById('date').value;
    url = url + "&description=" + document.getElementById('description').value;
    url = url + "&handled=" + document.getElementById('handled').value;
    url = url + "&order_quantity=" + document.getElementById('order_quantity').value;
...
function add_tmp() {
    ...
    url = url + "&reference_no=" + document.getElementById('reference_no').value;
    url = url + "&no=" + document.getElementById('no').value;
    ...
    url = url + "&outs=" + document.getElementById('outs').value;
