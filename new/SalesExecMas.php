...
<html lang="en">
    <head>
        <title>Sales Executive Master File</title>
...
<!--                            <input type="text" name="q" class="form-control" placeholder="Search...">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>Sales Executive Master File</b></h3>
                        </div>
                        <form name= "form1" role="form" class="form-horizontal">
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <h1>Details</h1>
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm" style="text-align:  left; background-color: #5A687B;  color: white;" for="invno">Sales Executive Code</label>
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="Sales Executive Code " id="exCodeTxt" class="form-control  input-sm ">
                                        </div> 
                                    ...
                                    <div class="form-group-sm" >
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color:#5A687B; margin-top: -12px;" for="invno">Sales Executive Name</label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Sales Executive Name" id="exNameTxt" class="form-control  input-sm ">
                                        </div>  
                                    ...
                                    <div class="form-group-sm" >
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color:#5A687B; margin-top: -12px;" for="invno">ID No</label>
                                        <div class="col-sm-2">
                                ...
                                <div class="col-md-12">
                                    <h1>Address</h1>
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm" style="text-align:  left; background-color: #5A687B;  color: white;" for="invno">Address</label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Address " id="addTxt" class="form-control  input-sm ">
                                        </div> 
                                    ...
                                    <div class="form-group-sm" >
                                        <label class="col-sm-2 input-sm " style="text-align: left;  margin-top: -12px;" for="invno"></label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Type Name" id="typeNameTxt" class="form-control  input-sm ">
                                        </div>  
                                ...
                                <div class="col-md-12">
                                    <h1>Conatacts</h1>
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm" style="text-align:  left; background-color: #5A687B;  color: white;" for="invno">Telephone NO</label>
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="Telephone NO" id="telTxt" class="form-control  input-sm ">
                                        </div> 
                                    ...
                                    <div class="form-group-sm" >
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color:#5A687B; margin-top: -12px;" for="invno">Mobile NO</label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group-sm" >
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color:#5A687B; margin-top: -12px;" for="invno">Email</label>
                                        <div class="col-sm-6">
                ...
                <script src="js/SalesExecMas.js"></script>
