...
<fieldset>
  ...
  <tr>
    <td height="41"><input type="text"  class="label_purchase" value="Invoice No" disabled="disabled"/></td>
    <td><input type="text" size="5" name="refInv" id="refInv" class="text_purchase"/></td>
    <td width="10%"></td>
    <td colspan="2"></td>
    <td></td>
    <td></td>
...
<fieldset>               
  ...
  <tr>
    ...
    <td><font color="#FFFFFF">
      <input type="text" size="15" name="qty" id="qty" value="" onblur="settotal();"  onkeyup="settotal();" class="text_purchase3" onkeypress="keyset('subtotal',event);"/><input type="hidden" size="15" name="discount" id="discount" value="" disabled class="txtbox" />
    </font></td>
    <td><font color="#FFFFFF">
