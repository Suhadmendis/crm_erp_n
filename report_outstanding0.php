		...
		while($row = mysql_fetch_array($result)){
			...
			if (strtoupper($row["C_CODE"])!=strtoupper($ccode)){
				if ($i!=0){
					...
					$sql1="SELECT * from s_cheq where  CR_FLAG='0' and cr_c_code = '". $row["C_CODE"] . "' and  CR_CHEVAL>PAID+1";
					$result1 =$db->RunQuery($sql1);
					while($row1 = mysql_fetch_array($result1)){
						echo "<tr>
						<td></td>
						<td><font color=\"#FF0000\">".$row1["CR_CHDATE"]."</font></td>
						<td></td>
						<td><font color=\"#FF0000\">".$row1["CR_CHNO"]."</font></td>
						<td></td>
						<td></td>
						<td  align=right><font color=\"#FF0000\">".number_format($row1["CR_CHEVAL"], 2, ".", ",")."</font></td>";
						
						$bal=$row1["CR_CHEVAL"]-$row1["PAID"];
						echo "<td align=right><font color=\"#FF0000\">".number_format($bal, 2, ".", ",")."</font></td></tr>";
						$PAID=$PAID+$bal;
					}
					
					$tot=$balance+$PAID;
					echo "<tr>
					<td colspan=9 align=right><b>".number_format($tot, 2, ".", ",")."</b></td>
					</tr>";
				} 
				$i=1;	
				...
				echo "<tr>
					<th colspan=9 align=left><b>".$row["C_CODE"]." ".$row_cus["NAME"]."</b></th>
					</tr>";
...
function currentrepcus()
{
	...
	if ($_GET["cmbbrand"] == "All") {
        if ($_GET["cmbdev"] == "All") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and CANCELL='0' group by CUS_NAME ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and CANCELL='0' group by CUS_NAME";
			}
        }
         
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='1'  group by  CUS_NAME ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and CANCELL='0' and DEV='1' group by CUS_NAME";
			}	
        }
         
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='0'  group by CUS_NAME";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and CANCELL='0' and DEV='0'  group by CUS_NAME";
			}	
        }
	}
	...
	if ($_GET["cmbbrand"] != "All") {
        if ($_GET["cmbdev"] == "All") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'   group by CUS_NAME" ;
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'  group by CUS_NAME ";
        	}
		}
         
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "'   group by CUS_NAME";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "'  group by CUS_NAME";
			}	
        }
         
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' group by CUS_NAME";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and CANCELL='0' and DEV='0'  and Brand='" . $_GET["cmbbrand"] . "'   group by CUS_NAME";
			}	
        }
	}
...
{  
	...
	if ($_GET["cmbbrand"] == "All") {
    	if ($_GET["chkpe"] != "on") {
        	if ($_GET["cmbdev"] == "All") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' order by SDATE";
                }
             } 
             if ($_GET["cmbdev"] = "Computer") {
             	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' order by SDATE";
				 }	
                 if ($_GET["cmbrep"] != "All") { 
				 	$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' order by SDATE";
                 }
			 }   
                
             if ($_GET["cmbdev"] == "Manual") {
             	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1'order by SDATE";
				}	
             }
        }
        ...
        if ($_GET["chkpe"] == "on") {
        	if ($_GET["cmbdev"] == "All") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "')  and CANCELL='0' order by SDATE";
				 }	
                 if ($_GET["cmbrep"] != "All") { 
				 	$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' order by SDATE";
				 }	
            }
               
            if ($_GET["cmbdev"] == "Computer") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0' order by SDATE";
				}	
            }
                
            if ($_GET["cmbdev"] == "Manual") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1' order by SDATE";
				}	
            }
        }
 	}
	...
	if ($_GET["cmbbrand"] != "All") {
    	if ($_GET["chkpe"] != "on") {
        	if (cmbdev == "All") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
               
            if (cmbdev == "Computer") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
                
            if (cmbdev == "Manual") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
        }
        ...
        if ($_GET["chkpe"] == "on") {
            if (cmbdev == "All") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "')  and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
               
            if (cmbdev == "Computer") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0'and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
                
            if (cmbdev == "Manual") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and rep='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1'  and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
        }
 	}
	...
	if ($_GET["cmbbrand"] == "All") {
    	if ($_GET["cmbdev"] == "All") {
        	if ($cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and CANCELL='0'";
			}	
        	if ($cmbrep != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and rep='" . $rep . "'  and CANCELL='0'";
			}	
    	}
    
    	if ($_GET["cmbdev"] == "Manual") {
        	if ($cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and DEV='1'  and CANCELL='0' ";
			}	
        	if ($cmbrep != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and rep='" . $rep . "' and DEV='1'  and CANCELL='0' ";
			}	
    	}
    
    	if ($_GET["cmbdev"] == "Computer") {
        	if ($cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and DEV='0'  and CANCELL='0' ";
			}	
        	if ($cmbrep != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and rep='" . $rep . "' and DEV='0'  and CANCELL='0'";
			}	
		}
	}
	...
	if ($_GET["cmbbrand"] != "All") {
    	if ($_GET["cmbdev"] == "All") {
        	if ($cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        	if ($cmbrep != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and rep='" . $rep . "'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
    		}
    
    	if ($_GET["cmbdev"] == "Manual") {
        	if ($cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and DEV='1'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
        	if ($cmbrep != "All") { 
				$rst1 ="SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and rep='" . $rep . "' and DEV='1'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
    	}
    
    	if ($_GET["cmbdev"] == "Computer") {
        	if ($cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and DEV='0'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
        	if ($cmbrep != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and rep='" . $rep . "' and DEV='0'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
    	}
	}
	...
	if ($_GET["cmbbrand"] == "All") {
        if ($_GET["cmbdev"] == "All") {
            if (cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "'  and CANCELL='0' ";
			}	
            if (cmbrep <> "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "'  and CANCELL='0'";
			}	
        }
        
        if ($_GET["cmbdev"] == "Computer") {
            if (cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='0'  and CANCELL='0' ";
			}	
            if (cmbrep <> "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "' and DEV='0'  and CANCELL='0' ";
			}	
        }
        
        if ($_GET["cmbdev"] == "Manual") {
            if (cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='1' and CANCELL='0' ";
			}	
            if (cmbrep <> "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "'and DEV='1'  and CANCELL='0'";
			}	
        }
	}
	...
	if ($_GET["cmbbrand"] <> "All") {
        if ($_GET["cmbdev"] == "All") {
            if (cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
            if (cmbrep <> "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "'  and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
        
        if ($_GET["cmbdev"] == "Computer") {
            if (cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='0'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
            if (cmbrep <> "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "' and DEV='0'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
        
        if ($_GET["cmbdev"] == "Manual") {
            if (cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='1' and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
            if (cmbrep <> "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "'and DEV='1'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
	}
	...
	if ($_GET["cmbbrand"] == "All") {
        if ($_GET["cmbdev"] == "All") {
            if (cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "'  and CANCELL='0' ";
			}	
            if (cmbrep <> "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "'  and CANCELL='0'";
			}
        }
        
        if ($_GET["cmbdev"] == "Computer") {
            if ($cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='0'  and CANCELL='0'";
			}	
            if ($cmbrep != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "' and DEV='0'  and CANCELL='0' ";
			}	
        }
        
        if ($_GET["cmbdev"] == "Manual") {
            if (cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='1'  and CANCELL='0' ";
			}	
            if (cmbrep <> "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "' and DEV='1'   and CANCELL='0'";
			}	
        }
	}
	...
	if ($_GET["cmbbrand"] <> "All") {
        if ($_GET["cmbdev"] == "All") {
            if (cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}
            if (cmbrep <> "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
        
        if ($_GET["cmbdev"] == "Computer") {
            if (cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='0'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
            if (cmbrep <> "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "' and DEV='0'  and CANCELL='0'   and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
        
        if ($_GET["cmbdev"] == "Manual") {
            if (cmbrep == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='1'  and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
            if (cmbrep <> "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from view_salma_vendor where Accname = 'NON STOCK' and GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and rep='" . $rep . "' and DEV='1'   and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
	}
    	...
    	if ($_GET["chk_svat"] != "on") {
        	if ($_GET["chkcus"]=="on") {
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor SDATE='".$_GET["dtfrom"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0'  order by id";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."' and C_CODE='".$_GET["txt_cuscode"]."'and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by REF_NO";
				}	
            	
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) {
				 	$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
				}	
            
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by REF_NO";
				}	
            	
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) {
				 	$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
				}	
            
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."'and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by REF_NO";
				}	
            
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
				}	
        	} else {
            	
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
				}	
            	
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
				}	
            
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."'and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0'  order by REF_NO";
				}	
            	
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
				}	
            	
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and rep='".$_GET["cmbrep"]."'and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by REF_NO";
				}
					
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and rep='".$_GET["cmbrep"]."'and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
				}	
            	
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]. "'and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by REF_NO";
				}	
            
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) {
				 	$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."'and CANCELL='0' order by id";
				}	
        	}
    	} else {
        	if ($_GET["chkcus"]=="on") {
				...
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by id";
				}	
            	
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0'  order by id";
				}	
            	
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) {
				 	$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."'and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by REF_NO";
				}	
            	
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) {
				 	$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0'  order by id";
				}	
            	
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by REF_NO";
				}	
            	
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by id";
				}	
            
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."'and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by REF_NO";
				}	
            	
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0' and SVAT > '0' order by id";
        		}
				
			} else {
            
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"] . "' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by id";
				}	
            	
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by id";
				}	
            	
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."'and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by REF_NO";
				}	
            	
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by id";
				}	
            	
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and rep='".$_GET["cmbrep"]."'and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by REF_NO";
				}	
            
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by id";
				}	
            
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]. "'and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and SVAT > '0' order by REF_NO";
				}	
            
				if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where  (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and CANCELL='0' and SVAT > '0' order by id";
        		}
			}	
    	}
...
function dis_sales()
{
	...
	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
		$sql = "SELECT * from view_s_invo where Brand_name='".$_GET["CmbBrand"]."' and DIS_per=".$_GET["txt_disper"]." and    SDATE='".$_GET["dtfrom"]."'  and DEV!='".$GLOBALS[$sysdiv]."'and rep='".$_GET["cmbrep"]."' and CANCELL='0'  order by SDATE";
	}	
	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
		$sql = "SELECT * from view_s_invo where Brand_name='".$_GET["CmbBrand"]."' and DIS_per=".$_GET["txt_disper"]." and    (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and DEV!='".$GLOBALS[$sysdiv]."'and rep='".$_GET["cmbrep"]."' and CANCELL='0'  order by SDATE";
	}	
	...
	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
		$sql = "SELECT * from view_s_invo where DIS_per=".$_GET["txt_disper"]." and    SDATE='".$_GET["dtfrom"]."'  and DEV!='".$GLOBALS[$sysdiv]."'and rep='".$_GET["cmbrep"]."' and CANCELL='0'  order by SDATE";
	}		
	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
		$sql = "SELECT * from view_s_invo where  DIS_per=".$_GET["txt_disper"]." and    (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and DEV!='".$GLOBALS[$sysdiv]."'and rep='".$_GET["cmbrep"]."' and CANCELL='0'  order by SDATE";
	}
...
function printscrap()
{
	...
	if ($_GET["radio"]=="optscrap") {
    	if ($_GET["chk_svat"] != "on") {
        	if ($_GET["chkcus"]=="on") {
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
				 	$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
            	}
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by REF_NO";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0'  order by id";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by REF_NO";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by REF_NO";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='" . $_GET["CmbBrand"] . "' and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."'and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0'  order by id";
        		}
			} else {
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by id";
            	}
				if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0'  order by id";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."'and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0'  order by REF_NO";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0'  order by id";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and rep='".$_GET["cmbrep"]."'and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0'  order by REF_NO";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0'  order by id";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."'and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0'  order by REF_NO";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and CANCELL='0' order by id";
				}	
        	}
    	} else {
			...
			if ($_GET["chkcus"]=="true"){
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
				 	$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0' and svat > '0' order by id";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and svat > '0'  order by id";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and svat > '0' order by REF_NO";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0' and svat > '0'  order by id";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and svat > '0' order by REF_NO";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and svat > '0' order by id";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0' and svat > '0' order by REF_NO";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and C_CODE='".$_GET["txt_cuscode"]."'and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0' and svat > '0' order by id";
				}	
        	} else {
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and svat > '0' order by id";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and DEV!='".$GLOBALS[$sysdiv]."' and CANCELL='0' and svat > '0' order by id";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."'and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0' and svat > '0' order by REF_NO";
				}	
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0' and svat > '0' order by id";
				}
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0' and svat > '0' order by REF_NO";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."') and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0' and svat > '0' order by id";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and SDATE='".$_GET["dtfrom"]."' and Brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."'and CANCELL='0' and svat > '0' order by REF_NO";
				}	
            	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
					$sql = "SELECT * from view_salma_vendor where Accname = 'NON STOCK' and (SDATE>'".$_GET["dtfrom"]."' or SDATE='".$_GET["dtfrom"]."') and (SDATE<'".$_GET["dtto"]."' or SDATE='".$_GET["dtto"]."')  and Brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and CANCELL='0' and svat > '0' order by id";
				}	
        	}
		}	
    }
...
function grnsummery()
{
	...
	if ($_GET["chk_svat"] != "on") {
    	...
    	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn where  CUSCODE='".$_GET["txt_cuscode"]."' and   trn_type='GRN' and SDATE='".$_GET["dtfrom"]."' and rep='".$_GET["cmbrep"]."' ";
		}	
    	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where  CUSCODE='".$_GET["txt_cuscode"]."' and   trn_type='GRN' and (SDATE='".$_GET["dtfrom"]."' or SDATE >'".$_GET["dtfrom"]."')and(SDATE='".$_GET["dtto"]."' or SDATE < '".$_GET["dtto"]."') and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."' ";
    	}
		if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn where  CUSCODE='".$_GET["txt_cuscode"]."' and   trn_type='GRN' and SDATE='".$_GET["dtfrom"]."' and brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' ";
		}	
    	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where  CUSCODE='".$_GET["txt_cuscode"]."' and   trn_type='GRN' and (SDATE='".$_GET["dtfrom"]. "' or SDATE >'".$_GET["dtfrom"]."')and(SDATE='".$_GET["dtto"]."' or SDATE < '".$_GET["dtto"]."') and brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."'and DEV!='".$GLOBALS[$sysdiv]."' ";
		}	
    	...
    	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
			$strsql = "select * from viewreturn where trn_type='GRN' and SDATE='".$_GET["dtfrom"]."' and rep='".$_GET["cmbrep"]."' ";
		}	
    	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where trn_type='GRN' and (SDATE='".$_GET["dtfrom"]."' or SDATE >'".$_GET["dtfrom"]."') and (SDATE='".$_GET["dtto"]."' or SDATE < '".$_GET["dtto"]."') and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."' ";
		}	
    	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn where trn_type='GRN' and SDATE='".$_GET["dtfrom"]."' and brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' ";
		}	
    	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where trn_type='GRN' and (SDATE='".$_GET["dtfrom"]."' or SDATE >'".$_GET["dtfrom"]."') and (SDATE='".$_GET["dtto"]."' or SDATE < '".$_GET["dtto"]."') and brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."' ";
		}	
	} else {
    	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
    	...
    	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn_svat where  CUSCODE='".$_GET["txt_cuscode"]."' and   trn_type='GRN' and SDATE='".$_GET["dtfrom"]."' and rep='".$_GET["cmbrep"]."' and SVAT > '0' ";
		}	
    	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn_svat where  CUSCODE='".$_GET["txt_cuscode"]."' and   trn_type='GRN' and (SDATE='".$_GET["dtfrom"]."' or SDATE >'".$_GET["dtfrom"]."')and(SDATE='".$_GET["dtto"]."' or SDATE < '".$_GET["dtto"]."') and rep='".$_GET["cmbrep"]."'and DEV!='".$GLOBALS[$sysdiv]."' and SVAT > '0' ";
		}	
    	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn_svat where  CUSCODE='".$_GET["txt_cuscode"]."' and   trn_type='GRN' and SDATE='".$_GET["dtfrom"]."' and brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and SVAT > '0' ";
		}	
    	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn_svat where  CUSCODE='".$_GET["txt_cuscode"]."' and   trn_type='GRN' and (SDATE='".$_GET["dtfrom"]."' or SDATE >'".$_GET["dtfrom"]."')and(SDATE='".$_GET["dtto"]."' or SDATE < '".$_GET["dtto"]."') and brand='".$_GET["CmbBrand"]."' and rep='".$_GET["cmbrep"]."' and DEV!='".$GLOBALS[$sysdiv]."' and SVAT > '0'";
		}	
    	...
    	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn_svat where trn_type='GRN' and SDATE='" . $_GET["dtfrom"] . "' and rep='" . $_GET["cmbrep"] . "' and SVAT > '0' ";
		}	
    	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn_svat where trn_type='GRN' and (SDATE='" . $_GET["dtfrom"] . "' or SDATE >'" . $_GET["dtfrom"] . "')and(SDATE='" . $_GET["dtto"] . "' or SDATE < '" . $_GET["dtto"] . "') and rep='" . $_GET["cmbrep"] . "'and DEV!='".$GLOBALS[$sysdiv]."' and SVAT > '0' ";
		}	
    	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]="optdaily")) {
		 	$strsql = "select * from viewreturn_svat where trn_type='GRN' and SDATE='" . $_GET["dtfrom"] . "' and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "' and SVAT > '0' ";
		}	
    	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn_svat where trn_type='GRN' and (SDATE='" . $_GET["dtfrom"] . "' or SDATE >'" . $_GET["dtfrom"] . "')and(SDATE='" . $_GET["dtto"] . "' or SDATE < '" . $_GET["dtto"] . "') and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "'and DEV!='".$GLOBALS[$sysdiv]."' and SVAT > '0' ";
		}	
	}
...
function crnsummery()
{
	...
	if ($_GET["chk_cash"] != "on") {
   		...
   		if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn where CUSCODE='" . $_GET["txt_cuscode"] . "' and (trn_type='CNT' OR  trn_type='INC') and SDATE='" . $_GET["dtfrom"] . "' and rep='" . $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' order by refno ";
		}	
   		if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where CUSCODE='" . $_GET["txt_cuscode"] . "' and (trn_type='CNT' OR  trn_type='INC')  and (SDATE='" . $_GET["dtfrom"] . "' or SDATE >'" . $_GET["dtfrom"] . "')and(SDATE='" . $_GET["dtto"] . "' or SDATE < '" . $_GET["dtto"] . "') and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "' order by refno ";
		}	
   		if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn where  CUSCODE='" . $_GET["txt_cuscode"] . "' and(trn_type='CNT' OR  trn_type='INC')  and SDATE='" . $_GET["dtfrom"] . "' and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' order by refno ";
		}	
   		if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where CUSCODE='" . $_GET["txt_cuscode"] . "' and (trn_type='CNT' OR  trn_type='INC')  and (Sdate='" . $_GET["dtfrom"] . "' or Sdate >'" . $_GET["dtfrom"] . "')and(Sdate='" . $_GET["dtto"] . "' or Sdate < '" . $_GET["dtto"] . "') and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "' order by refno ";
		}	
   		...
   		if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn where  (trn_type='CNT' OR  trn_type='INC') and SDATE='" . $_GET["dtfrom"] . "' and rep='" . $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' order by refno ";
		}	
   		if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where (trn_type='CNT' OR  trn_type='INC')  and (SDATE='" . $_GET["dtfrom"] . "' or SDATE >'" . $_GET["dtfrom"] . "')and(SDATE='" . $_GET["dtto"] . "' or SDATE < '" . $_GET["dtto"] . "') and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "' order by refno ";
		}	
   		if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn where  (trn_type='CNT' OR  trn_type='INC')  and SDATE='" . $_GET["dtfrom"] . "' and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' order by refno ";
		}	
   		if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where  (trn_type='CNT' OR  trn_type='INC')  and (Sdate='" . $_GET["dtfrom"] . "' or Sdate >'" . $_GET["dtfrom"] . "')and(Sdate='" . $_GET["dtto"] . "' or Sdate < '" . $_GET["dtto"] . "') and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "' order by refno";
		}	
	} else {
   		...
   		if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn where CUSCODE='" . $_GET["txt_cuscode"] . "' and (trn_type='CNT' OR  trn_type='INC') and SDATE='" . $_GET["dtfrom"] . "' and rep='" . $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' and flag1 = '1' order by refno ";
		}	
   		if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where CUSCODE='" . $_GET["txt_cuscode"] . "' and (trn_type='CNT' OR  trn_type='INC')  and (SDATE='" . $_GET["dtfrom"] . "' or SDATE >'" . $_GET["dtfrom"] . "')and(SDATE='" . $_GET["dtto"] . "' or SDATE < '" . $_GET["dtto"] . "') and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "' and flag1 = '1' order by refno ";
		}	
   		if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn where  CUSCODE='" . $_GET["txt_cuscode"] . "' and(trn_type='CNT' OR  trn_type='INC')  and SDATE='" . $_GET["dtfrom"] . "' and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' and flag1 = '1' order by refno ";
		}	
   		if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where CUSCODE='" . $_GET["txt_cuscode"] . "' and (trn_type='CNT' OR  trn_type='INC')  and (Sdate='" . $_GET["dtfrom"] . "' or Sdate >'" . $_GET["dtfrom"] . "')and(Sdate='" . $_GET["dtto"] . "' or Sdate < '" . $_GET["dtto"] . "') and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "' and flag1 = '1' order by refno ";
		}	
   		...
   		if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn where  (trn_type='CNT' OR  trn_type='INC') and SDATE='" . $_GET["dtfrom"] . "' and rep='" . $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' and flag1 = '1' order by refno ";
		}	
   		if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where (trn_type='CNT' OR  trn_type='INC')  and (SDATE='" . $_GET["dtfrom"] . "' or SDATE >'" . $_GET["dtfrom"] . "')and(SDATE='" . $_GET["dtto"] . "' or SDATE < '" . $_GET["dtto"] . "') and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "' and flag1 = '1' order by refno ";
		}	
   		if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) {
		 	$strsql = "select * from viewreturn where  (trn_type='CNT' OR  trn_type='INC')  and SDATE='" . $_GET["dtfrom"] . "' and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' and flag1 = '1' order by refno ";
		}	
   		if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) {
		 	$strsql = "select * from viewreturn where  (trn_type='CNT' OR  trn_type='INC')  and (Sdate='" . $_GET["dtfrom"] . "' or Sdate >'" . $_GET["dtfrom"] . "')and(Sdate='" . $_GET["dtto"] . "' or Sdate < '" . $_GET["dtto"] . "') and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "' and flag1 = '1' order by refno ";
		}
	}		
...
function Dgrnsummery()
{
	...
	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
		$strsql = "select * from viewreturn where CUSCODE='" . $_GET["txt_cuscode"] . "' and trn_type='DGRN' and SDATE='" . $_GET["dtfrom"] . "' and rep='" .  $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "'  order by REFNO";
	}	
	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) {
	 	$strsql = "select * from viewreturn where CUSCODE='" . $_GET["txt_cuscode"] . "' and trn_type='DGRN' and (SDATE='" . $_GET["dtfrom"] . "' or SDATE >'" . $_GET["dtfrom"] . "')and(SDATE='" . $_GET["dtto"] . "' or SDATE < '" . $_GET["dtto"] . "') and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "'  order by REFNO";
	}	
	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
		$strsql = "select * from viewreturn where CUSCODE='" . $_GET["txt_cuscode"] . "' and trn_type='DGRN' and SDATE='" . $_GET["dtfrom"] . "' and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "'  order by REFNO";
	}	
	if (($_GET["chkcus"] == "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
		$strsql = "select * from viewreturn where CUSCODE='" . $_GET["txt_cuscode"] . "' and trn_type='DGRN' and (SDATE='" . $_GET["dtfrom"] . "' or SDATE >'" . $_GET["dtfrom"] . "')and(SDATE='" . $_GET["dtto"] . "' or SDATE < '" . $_GET["dtto"] . "') and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "'  order by REFNO";
	}	
	...
	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
		$strsql = "select * from viewreturn where trn_type='DGRN' and SDATE='" . $_GET["dtfrom"] . "' and rep='" . $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "'  order by REFNO";
	}	
	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) { 
		$strsql = "select * from viewreturn where trn_type='DGRN' and (SDATE='" . $_GET["dtfrom"] . "' or SDATE >'" . $_GET["dtfrom"] . "')and(SDATE='" . $_GET["dtto"] . "' or SDATE < '" . $_GET["dtto"] . "') and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "'  order by REFNO";
	}	
	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
		$strsql = "select * from viewreturn where trn_type='DGRN' and SDATE='" . $_GET["dtfrom"] . "' and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "'  order by REFNO";
	}	
	if (($_GET["chkcus"] != "on") and ($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
		$strsql = "select * from viewreturn where trn_type='DGRN' and (SDATE='" . $_GET["dtfrom"] . "' or SDATE >'" . $_GET["dtfrom"] . "')and(SDATE='" . $_GET["dtto"] . "' or SDATE < '" . $_GET["dtto"] . "') and brand='" . $_GET["CmbBrand"] . "' and rep='" . $_GET["cmbrep"] . "'and DEV!='" . $GLOBALS[$sysdiv] . "'  order by REFNO";
	}
...
function summeryrep()
{
	...
	if ($_GET["radio2"]=="optdaily") { 
		$sql_sale = "select * from view_salma_vendor where  SDATE='".$_GET["dtfrom"]."' and DEV!='".$dev."' and CANCELL='0' ";
		
		if ($_GET["radio2"]=="optperiod") { 
			$sql_sale = "select * from view_salma_vendor where  ( SDATE='".$_GET["dtfrom"]."' OR  SDATE>'".$_GET["dtfrom"]."' ) AND ( SDATE='".$_GET["dtto"]."'  OR  SDATE<'".$_GET["dtto"]."' )and DEV!='".$dev."' and CANCELL='0'";
		}	
	...
	while ($row_c_bal = mysql_fetch_array($result_c_bal)){
		...
		if ($row_crnma = mysql_fetch_array($result_crnma)){
        	$sql_salma = " Select * from view_salma_vendor where  REF_NO = '" . $row_crnma["INVOICENO"] . "' ";
...
function summerysprte()
{
	...
	while ($row_brand = mysql_fetch_array($result_brand)){
		...
		if ($_GET["chkcus"] == "on") {
      		if ($_GET["cmbrep"] == "All") {
        		if ($_GET["radio2"]=="optdaily") { 
					$sql_sale = "select * from view_salma_vendor where  C_CODE ='".trim($_GET["txt_cuscode"]) . "' and SDATE='" . $_GET["dtfrom"] . "' and brand='" . $row_brand["barnd_name"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' and CANCELL='0' ";
				}	
        		if ($_GET["radio2"]=="optperiod") { 
					$sql_sale = "select * from view_salma_vendor where  c_code ='" . trim($_GET["txt_cuscode"]) . "' and ( SDATE='" . $_GET["dtfrom"] . "' OR  SDATE>'" . $_GET["dtfrom"] . "' ) AND ( SDATE='" . $_GET["dtto"] . "'  OR  SDATE<'" . $_GET["dtto"] . "' )and brand='" . $row_brand["barnd_name"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "'and CANCELL='0'  ";
      			}
      		}	
			
			if ($_GET["cmbrep"] != "All") {
        		if ($_GET["radio2"]=="optdaily") { 
					$sql_sale = "select * from view_salma_vendor where  c_code ='" . trim($_GET["txt_cuscode"]) . "' and sal_ex='" . trim($_GET["cmbrep"]) . "' and  SDATE='" . $_GET["dtfrom"] . "' and brand='" . $row_brand["barnd_name"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' and CANCELL='0' ";
				}	
        		
				if ($_GET["radio2"]=="optperiod") {  
					$sql_sale = "select * from view_salma_vendor where  c_code ='" . trim($_GET["txt_cuscode"]) . "' and sal_ex='" . trim($_GET["cmbrep"]) . "' and ( SDATE='" . $_GET["dtfrom"] . "' OR  SDATE>'" . $_GET["dtfrom"] . "' ) AND ( SDATE='" . $_GET["dtto"] . "'  OR  SDATE<'" . $_GET["dtto"] . "' )and brand='" . $row_brand["barnd_name"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "'and CANCELL='0'  ";
				}	
      		}
		}
		...
		if ($_GET["chkcus"]!="on") {  
      		if ($_GET["cmbrep"] == "All") {
        		if ($_GET["radio2"]=="optdaily") { 
					$sql_sale =  "select * from view_salma_vendor where  SDATE='" . $_GET["dtfrom"] . "' and brand='" . $row_brand["barnd_name"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' and CANCELL='0' ";
				}	
        		
				if ($_GET["radio2"]=="optperiod") { 
					$sql_sale = "select * from view_salma_vendor where  ( SDATE='" . $_GET["dtfrom"] . "' OR  SDATE>'" . $_GET["dtfrom"] . "' ) AND ( SDATE='" . $_GET["dtto"] . "'  OR  SDATE<'" . $_GET["dtto"] . "' )and brand='" . trim($row_brand["barnd_name"]) . "' and DEV!='" . $GLOBALS[$sysdiv] . "'and CANCELL='0'  ";
      			}
      		}
	  		
			if ($_GET["cmbrep"] != "All") {
        		if ($_GET["radio2"]=="optdaily") {
				 	$sql_sale = "select * from view_salma_vendor where  sal_ex='" . trim($_GET["cmbrep"]) . "' and  SDATE='" . $_GET["dtfrom"] . "' and brand='" . $row_brand["barnd_name"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "' and CANCELL='0' ";
				}	
        		
				if ($_GET["radio2"]=="optperiod") { 
					$sql_sale = "select * from view_salma_vendor where  sal_ex='" . trim($_GET["cmbrep"]) . "' and ( SDATE='" . $_GET["dtfrom"] . "' OR  SDATE>'" . $_GET["dtfrom"] . "' ) AND ( SDATE='" . $_GET["dtto"] . "'  OR  SDATE<'" . $_GET["dtto"] . "' )and brand='" . $row_brand["barnd_name"] . "' and DEV!='" . $GLOBALS[$sysdiv] . "'and CANCELL='0'  ";
				}	
      		}
		}
...
function item_sales()
{
	...
	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optperiod")) {
	 	$sql = "SELECT * from view_s_invo where     (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and DEV!='" . $GLOBALS[$sysdiv] . "'and CANCELL='0' and rep='" . trim($_GET["cmbrep"]) . "'  order by SDATE";
	}	

	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
		$sql = "SELECT * from view_s_invo where    SDATE='" . $_GET["dtfrom"] . "'  and DEV!='" . $GLOBALS[$sysdiv] . "'and CANCELL='0' and rep='" . trim($_GET["cmbrep"]) . "'  order by SDATE";
	}	
	...
	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optperiod")) { 
		$sql = "SELECT * from view_s_invo where  brand='" . $_GET["CmbBrand"] . "' and     (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and DEV!='" . $GLOBALS[$sysdiv] . "'and CANCELL='0' and rep='" . trim($_GET["cmbrep"]) . "'  order by SDATE";
	}	

	if (($_GET["cmbrep"] != "All") and ($_GET["CmbBrand"] != "All") and ($_GET["radio2"]=="optdaily")) { 
		$sql = "SELECT * from view_s_invo where   brand='" . $_GET["CmbBrand"] . "' and   SDATE='" . $_GET["dtfrom"] . "'  and DEV!='" . $GLOBALS[$sysdiv] . "'and CANCELL='0' and rep='" . trim($_GET["cmbrep"]) . "'  order by SDATE";
	}
