        ...
        <form role="form" name ="form1" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <a onclick="NewWindow('search_proforma_invoice.php', 'mywin', '1200', '600', 'yes', 'center');" class="btn btn-info btn-sm">
                        <span class="glyphicon glyphicon-search"></span> &nbsp; FIND
                    </a>


                    <a style="float: right;margin-right: 10px;" onclick="NewFullWindow('list_proforma_invoice.php', 'mywin', 'yes', 'center');" class="btn btn-info btn-sm">
                        <span class="glyphicon glyphicon-search"></span> &nbsp; List
                    </a>
...
<script src="js/proforma_invoice.js"></script>

<?php
include 'autocompleJUI/proformainvoice.php';
include 'login.php';
include './cancell.php';
?>
<script>
