...
function newent() {
    document.getElementById('sjrequestref_txt').value = "";
...
function getdt() {
    ...
    var url = "samplejobrequestnote_data.php";
...
function assign_dt() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        document.getElementById('sjrequestref_txt').value = XMLAddress1[0].childNodes[0].nodeValue;
    }
}
