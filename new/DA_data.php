...
if ($_GET["Command"] == "save_item") {
    ...
    try {
        ...
        $sql = "delete from da where ref_no = '" . $_GET['ref_no'] . "'";
        $result = $conn->query($sql);



        $sql = "Insert into da (ref_no,da_date,cus_code,cus_name,mar_code,mar_name,pro_des,wrk_path,con_path,cos_path)values 
