        ...
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-3 control-label" for="invdate">Job Ref</label>
                    <div class="col-sm-2">
                        <input type="text" placeholder="Job Ref" id="job_ref" class="form-control  input-sm">
                    </div>                    
                </div>
                ...
                <table class="table table-striped hidden">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" onclick="NewWindow('serach_item.php?stname=min', 'mywin', '800', '700', 'yes', 'center');
