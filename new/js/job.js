...
function pass_rec_result()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        if ((stname == "") || (stname == "mrn") || (stname == "ming") || (stname == "isa") || (stname == "ginu") || (stname == "mrni") || (stname == "mrng")) {
            ...
            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("descriptname");
            opener.document.form1.itemDesc.value = XMLAddress1[0].childNodes[0].nodeValue;

            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("cust");
            opener.document.form1.txt_cust_code.value = XMLAddress1[0].childNodes[0].nodeValue;


            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("custname");
            opener.document.form1.txt_cust.value = XMLAddress1[0].childNodes[0].nodeValue;
