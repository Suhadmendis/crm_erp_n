...
if ($_GET["Command"] == "getdt") {
    ...
    $tb .= "<tr>";
    $tb .= "<th class=\"succes;\" style=\"width: 350px;\"> Code</th>";
    $tb .= "<th style=\"width: 500px;\"> Name</th>";
    ...
    foreach ($conn->query($sql) as $row) {
        $tb .= "<tr>";
        $tb .= "<td onclick=\"getcode('" . $row['seg_code'] . "','" . $row['seg_name'] . "')\">" . $row['seg_code'] . "</td>";

        $tb .= "<td onclick=\"getcode('" . $row['seg_code'] . "','" . $row['seg_name'] . "')\">" . $row['seg_name'] . "</td>";
        $tb .= "</tr>";
    }
    $tb .= "</table>";
...
if ($_GET["Command"] == "save_item") {
    ...
    try {
        ...
        $sql = "delete from mar_seg_mas where seg_code = '" . $_GET['seg_code'] . "'";
        $result = $conn->query($sql);



        $sql = "Insert into mar_seg_mas (seg_code,seg_name)values 
    ('" . $_GET['seg_code'] . "', '" . $_GET['seg_name'] . "') ";
