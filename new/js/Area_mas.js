...
function newent() {
    ...
    document.getElementById('areaCodeTxt').value = "";
    document.getElementById('areaNameTxt').value = "";
    document.getElementById('mileageTxt').value = "";
...
//    }
    ...
    url = url + "&area_mi=" + document.getElementById('mileageTxt').value;
