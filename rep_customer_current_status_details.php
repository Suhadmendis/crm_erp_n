    ...
    <form id="form1" name="form1" action="report_customer_current_summery_details.php" target="_blank" method="get">
        <table width="767" border="0">
            ...
            <tr>
                ...
                <td width="245"><a href="" onclick="NewWindow('serach_customer.php', 'mywin', '800', '700', 'yes', 'center');
                        return false" onfocus="this.blur()"><input type="text" name="cusname" id="cusname" class="text_purchase3"/>

                    </a></td>
                <td width="234"><a href="serach_customer.php?stname=rep_outstand_state" onclick="NewWindow(this.href, 'mywin', '800', '700', 'yes', 'center');
            ...
            <tr>
                <td width="274" align="left"><table width="274">
                        <tr>
                            <td width="76" align="left"><input type="text"  class="label_purchase" value="DaysOn" disabled/></td>
                            <td width="186"><input type="text" name="lmt" id="lmt" class="text_purchase3" value="120"/></td>
                        </tr>
                    </table></td>
            </tr>
            <tr>
