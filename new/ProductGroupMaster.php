...
<html lang="en">
    <head>
        <title>Product Group Master File</title>
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>Product Group Master File</b></h3>
                        </div>
                            ...
                            <div class="box-body">
                               ...
                               <input type="hidden" id="tmpno" class="form-control">
                                ...
                                <div class="form-group-sm">
                                    ...
                                    <a  onclick="savenv();" class="btn btn-danger btn-sm">
                                        <span class="fa fa-save"></span> &nbsp; Prev
                                    </a>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group-sm">
                                         <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Group Code</label>
                                         <div class="col-sm-2">
                                            <input type="text" placeholder="Group Code" id="groupCodeTxt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                                         <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Group Name</label>
                                         <div class="col-sm-6">
                                            <input type="text" placeholder="Group Name" id="groupNameTxt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group">
                                        <label class="col-sm-2 input-sm " style="text-align: left;" for="invno"></label>
                                            Finish Goods &nbsp;&nbsp;&nbsp;<input type="radio" name="radio" value="Finish Goods" id="radio1" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            Row Materials &nbsp;&nbsp;&nbsp;<input type="radio" name="radio" value="Row Meterials" id="radio2" />
                                        </div>
                                </div>
