...
<form name="form1" id="form1">            
  ...
  <tr>
    <td width="14%"><input type="text"  class="label_purchase" value="GRN No" disabled/></td>
  ...
  <tr>
    <td><input type="text"  class="label_purchase" value="Manuel No " disabled="disabled"/></td>
    <td><input id="lc_no" type="text" class="text_purchase3" /></td>
    <td><input type="text"  class="label_purchase" value="PO No " disabled="disabled"/></td>
  ...
  <tr>
    ...
    <td><input type="text"  class="label_purchase" value="Order by" disabled="disabled"/></td>
