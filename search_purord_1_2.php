...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="JavaScript" src="js/pur_ord_1_2.js"></script>
        <style type="text/css">
        ...
        <div class="CSSTableGenerator" >
            <div id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
					...
					if (($stname!="arn")&&($stname!="req")){
                    	$sql = "SELECT * FROM s_ordmas_1_2 order by SDATE DESC limit 50";
					} else {
						$sql = "SELECT * FROM s_ordmas_1_2 where cancel='0' order by SDATE DESC limit 50";
					}	
//                    echo $sql;                    
