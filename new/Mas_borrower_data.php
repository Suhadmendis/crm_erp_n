...
if ($_GET["Command"] == "save_item") {
    ...
    try {
        ...
        $sql = "delete from master_borrower where b_code = '" . $_GET['b_code'] . "'";
        $result = $conn->query($sql);



        $sql = "Insert into master_borrower (b_code,b_name,b_add,b_tel,b_fax,b_email,b_conPerson)values 
    ('" . $_GET['b_code'] . "', '" . $_GET['b_name'] . "', '" . $_GET['b_add'] . "','" . $_GET['b_tel'] . "', '" . $_GET['b_fax'] . "', '" . $_GET['b_email'] . "', '" . $_GET['b_conPerson'] . "') ";
