	...
	xmlHttp=GetXmlHttpObject();
		...
		var url='advance_data.php';	
			...
			if (document.getElementById('paytype').value == "Cash") {
				params =params + '&txtoverpay='+document.getElementById('cashtot').value;
			}else{
				params =params + '&txtoverpay='+document.getElementById('chqtot').value;
			}
