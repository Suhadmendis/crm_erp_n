...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" href="css/bootstrap.min.css">
            ...
            <script language="JavaScript" src="js/Search_Location.js"></script>
    ...
    <body>
        ...
        <div id="filt_table" class="CSSTableGenerator">  <table width="735"   class="table table-bordered">
                ...
                $sql = $sql . " order by loc_code limit 50";
                ...
                foreach ($conn->query($sql) as $row) {
                    $cuscode = $row['loc_code'];
                    echo "<tr> 
                             
                              <td onclick=\"custno('$cuscode');\">" . $row['loc_code'] . "</a></td>
                              <td onclick=\"custno('$cuscode');\">" . $row['loc_name'] . "</a></td>
