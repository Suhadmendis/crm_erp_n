...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">MIN IS UT</h3>
        </div>
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('serach_gin.php?stname=ginu', 'mywin', '800', '700', 'yes', 'center');
                                return false" href="">
                ...
                <div class="form-group">
                    <label class="col-sm-1 control-label" for="invno">IS No</label>
                    <div class="col-sm-2">
                        <input type="text" placeholder="IS No" id="txt_jobno" class="form-control  input-sm">
                    </div>
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('serach_gin.php?stname=pick_is', 'mywin', '800', '700', 'yes', 'center');
                                return false" href="">
                            <input type="button" class="btn btn-default" value="..." id="searchcust" name="searchcust">
                        </a>
                    </div>                    
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="" onclick="NewWindow('serach_job.php?stname=pickJOB_is_ut', 'mywin', '800', '700', 'yes', 'center');
                        ...
                        <td>
                            <a href="" onclick="NewWindow('serach_item.php?stname=isn_ut', 'mywin', '800', '700', 'yes', 'center');
                                    return false" onfocus="this.blur()">
                                <input type="button" name="searchcusti" id="searchcusti" value="..." class="btn btn-default btn-sm">
                            </a>
                        </td>                        
...
<script src="js/gin_is_ut.js"></script>
<script>
                            new_inv();
</script>
<?php
