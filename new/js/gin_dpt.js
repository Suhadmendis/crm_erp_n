...
function save_inv() {
    ...
    url = url + "&customer_po=" + document.getElementById("customer_po").value;
    url = url + "&manuel_aod=" + document.getElementById("manuel_aod").value;
    url = url + "&supplier_vendor_no=" + document.getElementById("supplier_vendor_no").value;
    url = url + "&vehicle=" + document.getElementById("vehicle").value;
    url = url + "&contact_person=" + document.getElementById("contact_person").value;
...
function new_inv() {
    ...
    document.getElementById("manuel_aod").value = "";
    document.getElementById("supplier_vendor_no").value = "";
...
function validat() {
    var upNum = parseFloat(document.getElementById("balTrfd").value) || 0;

    // document.getElementById("wcell").setAttribute("title", "Maximum QTY -"+upNum);


    var downNum = parseFloat(document.getElementById("qty").value) || 0;

    if (upNum < downNum) {

        document.getElementById("balTrfd").style.borderColor = "red";

        document.getElementById("qty").value = "";
        setTimeout(function () {

            document.getElementById("balTrfd").style.borderColor = "#d2d6de";
