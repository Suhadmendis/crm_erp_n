...
function myfun(x) {
    ...
    var vari = "bal" + x.rowIndex;

    var num1 = parseFloat(document.getElementById("user" + x.rowIndex).innerHTML) || 0;
    var num2 = parseFloat(document.getElementById("user" + x.rowIndex).getAttribute("tempcal")) || 0;
    var tot = num2 - num1;
    if (num1 <= num2) {

        document.getElementById(vari).innerHTML = tot.toFixed(4);
    } else {

        document.getElementById("user" + x.rowIndex).innerHTML = "";
    }

    // alert(document.getElementById("user" + x.rowIndex).getAttribute("tempcal"));


    // if (document.getElementById("user" + x.rowIndex).value == "") {
    //    var temp = document.getElementById("user" + x.rowIndex)[0].getAttribute("tempcal");
    //    alert(temp);
    // }
