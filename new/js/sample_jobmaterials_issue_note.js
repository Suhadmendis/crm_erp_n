...
function newent() {
    document.getElementById('sjbno_txt').value = "";
    document.getElementById('sjbmrnref_txt').value = "";
    document.getElementById('date_txt').value = "";
    document.getElementById('sjbminref_txt').value = "";
    document.getElementById('manualref_txt').value = "";
    document.getElementById('remark_txt').value = "";
...
function getdt() {
    ...
    var url = "sample_jobmaterials_issue_note_data.php";
...
function assign_dt() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        document.getElementById('sjbno_txt').value = XMLAddress1[0].childNodes[0].nodeValue;
...
function save_inv() {
    ...
    document.getElementById('msg_box').innerHTML = "";
    if (document.getElementById('sjbno_txt').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Job Material Issue No. Enterd</span></div>";
        return false;
    }
    ...
    url = url + "&sjbno_txt=" + document.getElementById('sjbno_txt').value;
    url = url + "&uniq=" + document.getElementById('uniq').value;
    url = url + "&sjbmrnref_txt=" + document.getElementById('sjbmrnref_txt').value;
    url = url + "&date_txt=" + document.getElementById('date_txt').value;
    url = url + "&sjbminref_txt=" + document.getElementById('sjbminref_txt').value;
    url = url + "&manualref_txt=" + document.getElementById('manualref_txt').value;
    url = url + "&remark_txt=" + document.getElementById('remark_txt').value;
...
//    url = url + "&aodnumber=" + mid;
    ...
    url = url + "&materialname=" + document.getElementById('materialname').value;
    url = url + "&requiredqty=" + document.getElementById('requiredqty').value;
    url = url + "&exstock=" + document.getElementById('exstock').value;
    url = url + "&issueqty=" + document.getElementById('issueqty').value;
    url = url + "&balance_issued=" + document.getElementById('balance_issued').value;
    url = url + "&uom=" + document.getElementById('uom').value;
    url = url + "&uniq=" + document.getElementById('uniq').value;
...
function aodtmp() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
        ...
        document.getElementById('exstock').value;
        document.getElementById('issueqty').value;
        document.getElementById('balance_issued').value;
