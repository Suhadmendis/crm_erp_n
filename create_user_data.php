...
if($_GET["Command"]=="save_inv")
{
		...
		if ($row1 = mysql_fetch_array($result1)){
			...
			$sql="insert into user_mast(user_name, user_pass, user_level, dev, COMCODE) values ('".$_GET["user_name"]."', '".md5($_GET["pass1"])."', '".$_GET["user_level"]."', '".$_GET["division"]."', '" . $_SESSION["company"] . "')";
			$result =$db->RunQuery($sql);	
