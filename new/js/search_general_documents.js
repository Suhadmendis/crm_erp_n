...
function getdt() {
    ...
    var url = "search_general_documents_data.php";
...
function passcusresult_quot()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        opener.document.getElementById('docref').value = XMLAddress1[0].childNodes[0].nodeValue;
        
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_customername1");
        opener.document.getElementById('manno').value = XMLAddress1[0].childNodes[0].nodeValue;


        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_customername2");
        opener.document.getElementById('gflag').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        opener.document.getElementById('notes').value = XMLAddress1[0].childNodes[0].nodeValue;
