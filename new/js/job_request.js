...
function save_inv() {
    ...
    if (document.getElementById('Marketing_Ex').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Marketing Ex Not Selected</span></div>";
        return false;
    }
    ...
    url = url + "&quotation_id=" + document.getElementById('quotation_id').value;
    url = url + "&costing_id=" + document.getElementById('costing_id').value;
    url = url + "&tmpno=" + document.getElementById('tmpno').value;
    ...
    url = url + "&mark_ex=" + document.getElementById('Marketing_Ex').value;
   // url = url + "&pro_des=" + document.getElementById('Product_Description').value;
    url = url + "&jr_qty=" + document.getElementById('JR_Qty').value;
    // url = url + "&new_or_repeat=" + document.getElementById('cusText').value;
...
function print() {
    var url = "job_request_print.php";
    url = url + "?jrref=" + document.getElementById('txt_entno').value;
