...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td width="10%"><input type="text" size="20" name="grndate" id="grndate" onfocus="load_calader('grndate');" value="<?php echo date("Y-m-d"); ?>" class="text_purchase3"/>     </td>
  ...
  <tr>
    ...
    <td><div style="color: #ff0000;font-size: 24px;font-weight: bold;" id="cancelid"></div></td>
    <td>&nbsp;</td>
