...
function newent() {
    ...
    document.getElementById('cTy_code_txt').value = "";
    document.getElementById('cTy_des_txt').value = "";
    document.getElementById('cTy_bRate_txt').value = "";
...
function save_inv() {
    ...
    if (document.getElementById('cTy_code_txt').value == "") {
    ...
    if (document.getElementById('cTy_des_txt').value == "") {
    ...
    if (document.getElementById('cTy_bRate_txt').value == "") {
...
//    }
    ...
    url = url + "&c_code=" + document.getElementById('cTy_code_txt').value;
    url = url + "&c_name=" + document.getElementById('cTy_des_txt').value;
    url = url + "&bank_rate=" + document.getElementById('cTy_bRate_txt').value;
