...
function newent() {
    ...
    document.getElementById('designerNameText').value = "";
    document.getElementById('designerCodeText').value = "";
...
function save_inv() {
    ...
    if (document.getElementById('designerNameText').value == "") {
    ...
    if (document.getElementById('designerCodeText').value == "") {
    ...
    var url = "DesignMaster_Data.php";
    url = url + "?Command=" + "save_item";


    // if (document.getElementById('fixedOHCheck').checked == true) {
    //     url = url + "&check1" + "=Y";
    // } else {
    //     url = url + "&check1" + "=N";category,description
    // }


    url = url + "&d_code=" + document.getElementById('designerNameText').value;
    url = url + "&d_name=" + document.getElementById('designerCodeText').value;
