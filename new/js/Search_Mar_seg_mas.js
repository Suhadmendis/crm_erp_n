...
function getdt() {
    ...
    var url = "Search_Mar_seg_mas_data.php";
...
function passcusresult_quot()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        opener.document.form1.marExCodeTxt.value = XMLAddress1[0].childNodes[0].nodeValue;


        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("name");
        opener.document.form1.marExNameTxt.value = XMLAddress1[0].childNodes[0].nodeValue;
