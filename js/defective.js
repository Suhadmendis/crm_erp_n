...
function pass_defect_result_d()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		opener.document.form1.txtadd.value = XMLAddress1[0].childNodes[0].nodeValue;
                ...
                XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("refInv");	
		opener.document.form1.refInv.value = XMLAddress1[0].childNodes[0].nodeValue;
		...
		if ((XMLAddress1[0].childNodes[0].nodeValue)=="1"){
			...
			window.opener.document.getElementById('cancelid').innerHTML ="";	
                ...
                XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("chkCancel");	
		var chkCancel = XMLAddress1[0].childNodes[0].nodeValue;
...
{   
		...
		//} else {
			...
			url=url+"&vatmethod="+vatmethod;
			url=url+"&refInv="+document.getElementById('refInv').value;
...
function print_inv()
{
	...
	//	if (xmlHttp.responseText==1){
			...
			url=url+"&txt_net="+document.getElementById('txt_net').value;
			url=url+"&txt_cuscode="+document.getElementById('txt_cuscode').value;
			url=url+"&status="+document.getElementById('cancelid').innerHTML;
			...
			if (document.form1.vatgroup_0.checked==true){
				vatmethod="vat";
			} else if (document.form1.vatgroup_1.checked==true){
				vatmethod="non";
			} else if (document.form1.vatgroup_2.checked==true){
				vatmethod="svat";
			} else if (document.form1.vatgroup_3.checked==true){
				vatmethod="evat";
			}
