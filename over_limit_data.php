...
if ((strtolower(trim($_GET["CURRENT_USER"])) == "gayal") or (strtolower($_SESSION["CURRENT_USER"]) == "rohan") or (strtolower($_SESSION["CURRENT_USER"]) == "rohan1")) {
...
if ($_SESSION["CURRENT_USER"]=="THT"){   
 ...
 if (($myg[8]<=0) or ($myg[11]!="0") or ($myg[5]>0)){  
   ...
   $ResponseXML .="<tr><td onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div id=\"".$myg01."\">".$myg[1]."</div></td>
						...
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg03."\">".$myg[3]."</div></td>
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg04."\">".number_format($myg[4], 2, ".", ",")."</div></td>
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg05."\">".number_format($myg[5], 2, ".", ",")."</div></td>
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg06."\">".number_format($myg[6], 2, ".", ",")."</div></td>
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg07."\">".number_format($myg[7], 2, ".", ",")."</div></td>
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg08."\">".number_format($myg[8], 2, ".", ",")."</div></td>
						...
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg10."\">".$myg[10]."</div></td>
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg11."\">".$myg[11]."</div></td>
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg12."\">".$myg[12]."</div></td>
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg13."\">".number_format($myg[13], 2, ".", ",")."</div></td>
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg14."\">".$myg[14]."</div></td>
						<td align=right onClick=\"NewWindow('sales_ord_new_display.php?txtrefno=".$ord_no."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\" ><div align=right id=\"".$myg15."\">".number_format($myg[15], 2, ".", ",")."</div></td>
	...
	//echo $_POST[$myg20];
		...
		//	$AUTH_USER="";
        	if (($_POST[$myg05] > 0) or ($_POST[$myg11] > 0)) {
				...
				if ((strtolower(trim($_GET["CURRENT_USER"])) == "gayal") or (strtolower(trim($_GET["CURRENT_USER"])) == "rohan") or (strtolower(trim($_GET["CURRENT_USER"])) == "rohan1")) {
				...
				if ((strtolower(trim($_GET["CURRENT_USER"])) == "gayal") or (strtolower(trim($_SESSION["CURRENT_USER"])) == "rohan") or (strtolower(trim($_SESSION["CURRENT_USER"])) == "rohan1")) {
