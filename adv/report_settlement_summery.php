 ...
 $row_invpara = mysql_fetch_array($result_invpara);
  ...
  if ($_GET["cmbbrand"] == "All") {
    ...
    if (trim($_GET["cmbrep"]) == "All") {
        ...
        if ($_GET["cmbdev"] == "Manual") { $sql = "SELECT * from view_sttr where  C_CODE='" . $_GET["cuscode"] . "' and (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "')  and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "') and DEV='1'"; }
        if ($_GET["cmbdev"] == "Computer") { $sql = "SELECT * from view_sttr where  C_CODE='" . $_GET["cuscode"] . "'  and (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "') and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "') and DEV='0'"; }
    } else {
        if ($_GET["cmbdev"] == "All") { $sql = "SELECT * from view_sttr where C_CODE='" . $_GET["cuscode"] . "' and (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "')  and  (ST_DATE='" . $_GET["dtto"] . "' or ST_DATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $_GET["cmbrep"] ; }
        if ($_GET["cmbdev"] == "Manual") { $sql = "SELECT * from view_sttr where  C_CODE='" . $_GET["cuscode"] . "' and (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "')  and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $_GET["cmbrep"] . " and DEV='1'"; }
        if ($_GET["cmbdev"] == "Computer") { $sql = "SELECT * from view_sttr where  C_CODE='" . $_GET["cuscode"] . "' and (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "')  and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $_GET["cmbrep"] . " and DEV='0'"; }
        $txtrep = "Sales Rep : " + trim($_GET["cmbrep"]);
    }
  } else {
    if (trim($_GET["cmbrep"]) == "All") {
        if ($_GET["cmbdev"] == "All") { $sql = "SELECT * from view_sttr where (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "') and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "')"; }
        if ($_GET["cmbdev"] == "Manual") { $sql = "SELECT * from view_sttr where (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "') and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "') and DEV='1'"; }
        if ($_GET["cmbdev"] == "Computer") { $sql = "SELECT * from view_sttr where (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "') and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "') and DEV='0'"; }
    } else {
        if ($_GET["cmbdev"] == "All") { $sql = "SELECT * from view_sttr where (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "') and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "')  and SAL_EX = " . $_GET["cmbrep"] ; }
        if( $_GET["cmbdev"] == "Manual") { $sql = "SELECT * from view_sttr where (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "') and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "')  and SAL_EX = " . $_GET["cmbrep"] . " and DEV='1'"; }
        if ($_GET["cmbdev"] == "Computer") { $sql = "SELECT * from view_sttr where (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "') and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $_GET["cmbrep"] . " and DEV='0'"; }
        $txtrep = "Sales Rep : " + trim($_GET["cmbrep"]);
    }
  }
}
...
////////////////////////////
	...
	if ($_GET["cmbdev"] == "Computer") { $txtdev = "S-2"; }
		...
		$sql=$sql."$phrase order by SDATE, ST_INVONO"; 
		//echo $sql;
		$result =$db->RunQuery($sql);
		while($row = mysql_fetch_array($result)){	
...
function invReT(){
 ...
 if ($_GET["chkcus"] == "on") {
     $sql = "SELECT * from view_ch_sttr where CR_C_CODE = '" . trim($_GET["cuscode"]) . "' and (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "') and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "')";
 } else {
     $sql = "SELECT * from view_ch_sttr where (ST_DATE='" . $_GET["dtfrom"] . "' or ST_DATE>'" . $_GET["dtfrom"] . "') and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "')";
 }
