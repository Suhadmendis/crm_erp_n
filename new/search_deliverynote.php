...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <script language="JavaScript" src="js/search_deliverynote.js"></script>
            ...
            <table width="735"   class="table table-bordered">
                ...
                foreach ($conn->query($sql) as $row) {
                    ...
                    echo "<tr>       
                              ...
                              <td onclick=\"custno('$cuscode', '$stname');\">" . $row['cus_txt'] . "</a></td>
                              <td onclick=\"custno('$cuscode', '$stname');\">" . $row['addr_txt'] . "</a></td>
