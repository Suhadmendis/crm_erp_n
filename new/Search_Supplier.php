...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" href="css/bootstrap.min.css">
            ...
            <script language="JavaScript" src="js/Search_Supplier.js"></script>
    ...
    <body>
        ...
        <div id="filt_table" class="CSSTableGenerator">  <table width="735"   class="table table-bordered">
                ...
                $sql = $sql . " order by sup_code limit 50";
                ...
                foreach ($conn->query($sql) as $row) {
                    ...
                    echo "<tr> 
                              ...
                              <td onclick=\"custno('$cuscode');\">" . $row['sup_code'] . "</a></td>
                              <td onclick=\"custno('$cuscode');\">" . $row['sup_name'] . "</a></td>
