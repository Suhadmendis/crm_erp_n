...
//
    ...
    $sql2 = "select * from samplejobreqnote";
...
//        }
            ...
            $tb .= "<tr>               
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['jrid'] . "</a></td>
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['jobreqdate'] . "</a></td>
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['customer'] . "</a></td>                              
                              <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['mkex'] . "</a></td></tr>";
