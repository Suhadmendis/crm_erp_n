...
<form name="form1" id="form1">  
 <table border="0"><tr><td width="1301">         
  ...
  <tr>
    ...
    <td width="13%"><input type="text"  class="label_purchase" value="Month 1" disabled="disabled"/></td>
  ...
  <tr>
    ...
    <td><input type="text" size="20" name="DTPicker2" id="DTPicker2" value="<?php echo date("Y-m-d"); ?>"  onfocus="load_calader('DTPicker2');" class="text_purchase3"/></td>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" size="20" name="DTPicker3" id="DTPicker3" value="<?php echo date("Y-m-d"); ?>"  onfocus="load_calader('DTPicker3');" class="text_purchase3"/></td>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
