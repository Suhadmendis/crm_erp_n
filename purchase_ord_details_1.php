    ...
    <form name="form1" id="form1">            
        <table width="100%" border="0"  class=\"form-matrix-table\">
            <tr>
                ...
                <td width="10%" hidden=""><input type="text"  class="label_purchase" value="Schedule Date" disabled="disabled"/></td>
                <td width="10%" hidden=""><input type="text" size="20" name="dte_shedule" id="dte_shedule" value="" class="text_purchase3"/>
                    <script type="text/javascript">
                        window.onload = function () {
                            new JsDatePick({
                                useMode: 2,
            ...
            <tr hidden="">
                ...
                <td><input type="text"  class="label_purchase" value="Manuel No" disabled/></td>
            ...
            <tr>
                ...
                <td><label>
                        <select name="department" id="department" onkeypress="keyset('brand', event);" onchange="setord();" class="text_purchase3">
                            <?php
                            $sql = "select * from deptinfo order by dpt_no";
                            $result = mysqli_query($GLOBALS['dbinv'], $sql);
                            while ($row = mysqli_fetch_array($result)) {
                                echo "<option value='" . $row["dpt_no"] . "'>" . $row["dpt_no"] . " - " . $row["dpt_name"] . "</option>";
                            }
                            ?>
                        </select>
                    </label></td>
            ...
            <tr>
                ...
                <td><label>
                        <input type="text"  class="label_purchase" value="Job No" disabled="disabled"/>
                    </label></td>
                <td><label>
                        <select name="Job_No" id="Job_No" onkeypress="keyset('brand', event);" onchange="setord();" class="text_purchase3">
                            <?php
                            $sql = "select * from joborder order by jid";
                            $result = mysqli_query($GLOBALS['dbinv'], $sql);
                            while ($row = mysqli_fetch_array($result)) {
                                echo "<option value='" . $row["jid"] . "'>" . $row["jid"] . "  -  " . $row["Customer"] . "</option>";
                            }
                            ?>
                        </select>
                    </label></td>
            ...
            <tr>
                <td height="41"><input type="text"  class="label_purchase" value="Marketing Executive" hidden disabled="disabled"/></td>
                <td><select name="salesrep" id="salesrep" onkeypress="keyset('dte_dor', event);" onchange="setord();" class="text_purchase3" hidden>
                        <?php
        ...
        <fieldset>               
            ...
            <table width="84%" border="0">
                <tr>
                    ...
                    <td  width="1px"><span class="style1" hidden="">
                ...
                <tr>
                    ...
                    <td><font color="#FFFFFF">
                        <input type="text" hidden="" size="15" name="partno" id="partno" value="" disabled="disabled" class="text_purchase3" onkeypress="keyset('qty', event);"/>
                        </font></td>
                    <td><font color="#FFFFFF">
                        <input type="text" size="15" name="qty" id="qty" value="" class="text_purchase3"  onKeyPress="keyset('cost', event);"/>
                        </font></td>
                    <td><font color="#FFFFFF">
                        <input type="text" size="15" name="cost" hidden="" id="cost" value="0" class="text_purchase3"  onKeyPress="keyset('additem_tmp', event);"/>
                        </font></td>
