...
function newent() {
    ...
    document.getElementById('overHcodeText').value = "";
    document.getElementById('overHDescText').value = "";
...
function save_inv() {
    ...
    if (document.getElementById('overHcodeText').value == "") {
    ...
    if (document.getElementById('overHDescText').value == "") {
    ...
    var url = "overHeadMaster_Data.php";
    ...
    url = url + "&o_code=" + document.getElementById('overHcodeText').value;
    url = url + "&o_name=" + document.getElementById('overHDescText').value;
