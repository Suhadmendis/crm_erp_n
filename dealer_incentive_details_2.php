	...
	window.onload = function(){
		new JsDatePick({
			...
			weekStartDay:1*/
                                                	...
                                                	<legend>
  <div class="text_forheader">Dealer Incentive - 3 Months</div>
                                               	 </legend>             
...
<form name="form1" id="form1">  
 <table border="0"><tr><td width="1301">         
  ...
  <tr>
    ...
    <td><a href="" onclick="NewWindow('serach_customer.php?stname=incentive2','mywin','800','700','yes','center');return false" onfocus="this.blur()">
      <input type="button" name="searchcust" id="searchcust" value="..."  class="btn_purchase" />
    </a></td>
    <td><input type="text"  class="label_purchase" value="Month 1" disabled="disabled"/></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="text"  class="label_purchase" value="Month 2" disabled="disabled"/></td>
    <td><input type="text" name="DTPicker2" id="DTPicker2" value="" class="text_purchase3"  onfocus="load_calader('DTPicker2')" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="text"  class="label_purchase" value="Month 3" disabled="disabled"/></td>
    <td><input type="text" name="DTPicker3" id="DTPicker3" value="" class="text_purchase3"  onfocus="load_calader('DTPicker3')" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td> 
      <input type="text" name="txt_percentage" id="txt_percentage" value="0" disabled="disabled"  class="text_purchase3"   />    </td>
    ...
    <td>      <input type="text" name="txt_vat" id="txt_vat" value="12" class="text_purchase3"   />    </td>
    <td><a href="serach_customer.php?stname=ret_chq_settle" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
  ...
  <tr>
    <td ><table  border="0">
      ...
      <tr>
        ...
        <td><input type="text" size="20" name="txttot_inc" id="txttot_inc" value="" disabled="disabled" class="text_purchase3"/></td>
        ...
        <td><input type="text" size="20" name="txt_out" id="txt_out" value="" class="text_purchase3"/></td>
      </tr>
      <tr>
        <td colspan="2">&nbsp;</td>
        <td width="11%">&nbsp;</td>
