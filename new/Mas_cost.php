...
<html lang="en">
    <head>
        <title>Cost/Profit Center Master File</title>
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>Cost/Profit Center Master File</b></h3>
                        </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group-sm">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="Cost Center" id="cost_txt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Description</label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Description" id="des_txt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                                ...
                                <script src="js/Mas_cost.js"></script>
                                <script>
                                     //   new_inv();
                                </script>
                                <!-- Modal -->
