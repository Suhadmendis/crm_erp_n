...
<table width="1900" height="21" border="0" cellspacing="0" style="margin-left: 80px;">
    <!--  <tr  bgcolor="#999999">
  ...
  <?php 
		...
		while ($row1 = mysql_fetch_array($result1)){
			...
			if (($VAT_per=="1") or ($VAT_per=="2")){
				...
				echo "<tr><td width=150><span class=\"style6\">".$row_item["PART_NO"]."</span></td>
						<td width=900><span class=\"style6\">".$row_item["BRAND_NAME"]." ".$row_item["STK_NO"]." ".$row_item["DESCRIPT"]."</span></td>
						<td align=\"right\"  width=50><span  class=\"style6\">".number_format($row1["QTY"], 0, ".", ",")."</span></td>
						<td  align=\"right\"  width=400><span  class=\"style6\">".number_format($PRICE, 2, ".", ",")."</span></td>";
						
			
						$discount1=$PRICE*$row1["QTY"]*$row1["DIS_per"]/100;
						$subtot=($PRICE*$row1["QTY"])-$discount1;
				echo "<td align=\"right\"  width=400><span  class=\"style6\">&nbsp;&nbsp;&nbsp;&nbsp;".number_format($subtot, 2, ".", ",")."</span></td>";
