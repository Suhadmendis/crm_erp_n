...
function newent() {
    ...
    document.getElementById('cost_txt').value = "";
...
//    }
    ...
    url = url + "&cost_cen=" + document.getElementById('cost_txt').value;
    url = url + "&code=" + document.getElementById('des_txt').value;
