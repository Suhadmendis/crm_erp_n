...
{   
			...
			if (stname=="modify"){
				...
				xmlHttp.onreadystatechange=passcusresult_cash_rec;
			} else if (stname=="advance_ar"){
				var url="search_custom_data.php";			
				url=url+"?Command="+"pass_cus_cash_rec";
				url=url+"&custno="+custno;
				url=url+"&refno="+opener.document.form1.salesrep.value;
				
				xmlHttp.onreadystatechange=passcusresult_advance_ar;
			
			} else if (stname=="cre_note"){
				var url="search_custom_data.php";			
				url=url+"?Command="+"pass_cus_cre_note";
				url=url+"&custno="+custno;
				// url=url+"&refno="+opener.document.form1.salesrep.value;
				
				xmlHttp.onreadystatechange=passcusresult_cre_note;
...
function passcusresult_advance_ar()
{
	var XMLAddress1;
...
function passcusresult_cre_note()
{
	var XMLAddress1;
