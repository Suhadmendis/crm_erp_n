...
<table width="1000"  border="0">
  <tr>
   ...
   if ($_GET["vat"]=="true"){
    ...
    <td colspan="4" align="center"><table width="500" border="0">
      <tr>
          <?php 
              echo "<td width=\"402\"><span class=\"style8\"></span></td>";
          ?>
  ...
  <tr>
    <td height="44" colspan="3" align="right"><span class="style6"><u></u></span></td>
  ...
  <tr>
    ...
    <td colspan="4" valign="top"><table border="1" bordercolor="#000000" cellpadding="0" cellspacing="0"><tr><td><table width="500" border="0">
      <tr>
          <td width="108"><span class="style4">&nbsp;</span></td>
        <td width="9">&nbsp;</td>
        <td width="146"><span><?php echo $row["use_name"]; ?></span></td>
        <td width="82"><span class="style4">&nbsp;</span></td>
        <td width="12">&nbsp;</td>
        <td width="201"><?php echo $row["REF_NO"]; ?></td>
      </tr>
      <tr>
        <td width="108"><span class="style4">&nbsp;</span></td>
        <td width="9">&nbsp;</td>
        <td width="146"><span class=""><?php echo $row_salrep["Name"]; ?></span></td>
        <td width="82"><span class="style4">&nbsp;</span></td>
        <td width="12">&nbsp;</td>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td><span class=""><?php echo $row["ORD_NO"]; ?></span></td>
  ...
  <?php 
		...
		while ($row1 = mysql_fetch_array($result1)){
			...
			if (($VAT_per=="1") or ($VAT_per=="2")){
				...
				echo "<tr><td><span width=100  class=\"style10\">".$row_item["PART_NO"]."</span></td>
						<td><span width=500  class=\"style10\">".$row_item["BRAND_NAME"]." ".$row_item["STK_NO"]." ".$row_item["DESCRIPT"]."</span></td>
						...
						<td align=\"right\"  width=50><span  class=\"style10\"></span></td>
						<td align=\"right\"  width=50><span  class=\"style10\"></span></td>";
