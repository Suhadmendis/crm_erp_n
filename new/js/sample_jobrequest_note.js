...
function save_inv() {
    ...
    url = url + "&customer_ref=" + document.getElementById('c_code').value;
...
//    url = url + "&aodnumber=" + mid;
    ...
    url = url + "&Sample_Description=" + document.getElementById('Sample_Description').value;
    url = url + "&Sample_Qty=" + document.getElementById('Sample_Qty').value;
    url = url + "&uniq=" + document.getElementById('uniq').value;
