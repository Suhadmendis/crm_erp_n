...
<fieldset>
  ...
  <tr>
    ...
    <td width="154"><a href="serach_rec.php?stname=adv_adv" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
  ...
  <tr>
    ...
    <td><a href="serach_customer.php?stname=advance_ar" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
...
//    if (($_SESSION['UserName']=="ptsa") or ($_SESSION['UserName']=="ptsb") or ($_SESSION['UserName']=="ptsc")){
  ...
  <tr>
    ...
    <td colspan="3"><input type="text"  class="text_purchase3"   id="cus_remark" name="cus_remark" /></td>
    <td>&nbsp;</td>
    <td></td>
    <td width="144">
  </td>
