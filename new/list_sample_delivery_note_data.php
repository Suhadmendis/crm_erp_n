...
//
    ...
    $sql2 = "select * from sampledeliverynote";
    ...
    $tb .= "<thead><tr>";
    $tb .= "<th>sampletransnote</th>";
    $tb .= "<th>aod</th>";
    $tb .= "<th>customer</th>";
    $tb .= "<th>deliverydate</th>";
    $tb .= "</tr></thead><tbody>";
...
//        }
            ...
            $tb .= "<tr>               
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['sampletransnote'] . "</a></td>
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['aod'] . "</a></td>
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['customer'] . "</a></td>
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['deliverydate'] . "</a></td></tr>";
