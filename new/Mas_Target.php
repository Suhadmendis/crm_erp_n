...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><b>Target Audience Master File</b></h3>
        </div>
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group-sm">
                        <label class="col-sm-2 input-sm" style="text-align:  left; " for="invno">T/G Code</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Code " id="TCodeTxt" class="form-control  input-sm ">
                        </div> 
                    ...
                    <div class="form-group-sm">
                        <label class="col-sm-2 input-sm" style="text-align:  left; " for="invno">T/G Name</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Name " id="TNameTxt" class="form-control  input-sm ">
                        </div> 
...
<script src="js/Mas_Target.js"></script>
