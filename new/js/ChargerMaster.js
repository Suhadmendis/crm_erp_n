...
function newent() {
    ...
    document.getElementById('chargeCodeText').value = "";
    document.getElementById('chargeDescText').value = "";
...
function save_inv() {
    ...
    if (document.getElementById('chargeCodeText').value == "") {
    ...
    if (document.getElementById('chargeDescText').value == "") {
    ...
    var url = "ChargerMaster_Data.php";
    ...
    url = url + "&c_code=" + document.getElementById('chargeCodeText').value;
    url = url + "&c_description=" + document.getElementById('chargeDescText').value;
