...
<html lang="en">
    <head>
        <title>PO Requisition Note-Dummy</title>
...
<!--                            <input type="text" name="q" class="form-control" placeholder="Search...">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>PO Requisition Note-Dummy</b></h3>
                        </div>
                            ...
                            <div class="box-body">
                               ...
                               <input type="hidden" id="tmpno" class="form-control">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group-sm">
                                         <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Manual No</label>
                                         <div class="col-sm-6">
                                            <input type="text" placeholder="Manual No" id="man_txt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                ...
                <script src="js/Po_reqDummy.js"></script>
                <script>
                                       //         new_inv();
                </script>
                <!-- Modal -->
