...
function newent() {
    ...
    document.getElementById('stageCodeText').value = "";
    document.getElementById('stageNameText').value = "";
...
function save_inv() {
    ...
    if (document.getElementById('stageCodeText').value == "") {
    ...
    if (document.getElementById('stageNameText').value == "") {
    ...
    url = url + "&s_code=" + document.getElementById('stageCodeText').value;
    url = url + "&s_name=" + document.getElementById('stageNameText').value;
