...
function passcusresult_quot()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        opener.document.form1.cusPO_txt.value = XMLAddress1[0].childNodes[0].nodeValue;

//
//        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("name");
//        opener.document.form1.proDesTxt.value = XMLAddress1[0].childNodes[0].nodeValue;
