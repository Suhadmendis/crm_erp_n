   ...
   <div class="CSSTableGenerator" > 
                <div id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
							...
							//if ($_GET["stname"]=="crn"){
								...
								$sql = "select REF_NO , SDATE, GRAND_TOT, TOTPAY  from s_salma where Accname='OFFICE' and CANCELL='0'and C_CODE='" . $_SESSION["crn_form_supplierno"] . "' and year(SDATE)='".$year."' and month(SDATE)='".$month."'   ORDER BY SDATE desc limit 50";
							//}
