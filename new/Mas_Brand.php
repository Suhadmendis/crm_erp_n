        ...
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group-sm">
                        <label class="col-sm-2 input-sm" style="text-align:  left;" for="invno">Code</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Code " id="exCodeTxt" class="form-control  input-sm ">
                        </div> 
                    ...
                    <div class="form-group-sm">
                        <label class="col-sm-2 input-sm" style="text-align:  left; " for="invno">Name</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Description " id="exCodeTxt" class="form-control  input-sm ">
                        </div> 
                    ...
                    <div class="form-group-sm">
                        <label class="col-sm-2 input-sm" style="text-align:  left; " for="invno">Customer</label>
                        <div class="col-sm-2">
                            <input type="text" placeholder="Description " id="exCodeTxt" class="form-control  input-sm ">
                        </div> 
                        <div class="col-sm-2">
