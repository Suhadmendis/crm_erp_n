...
//
    ...
    $sql2 = "select * from samplejobtransfer";
...
//        }
        ...
        $tb .= "<tr>               
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['sjtno'] . "</a></td>
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['sjtdate'] . "</a></td>     
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['customer'] . "</a></td></tr>";
