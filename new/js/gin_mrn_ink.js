...
// alert(document.getElementById('to_be_issued').value);
// alert(document.getElementById('qty').value);

// var num1 = document.getElementById('to_be_issued').value || 0;
// var num2 = document.getElementById('qty').value || 0;

        // if (num1 > num2){
            var qty = document.getElementById('qty').value;
            qty = parseFloat(qty);
            var url = "gin_data_mrn_ink.php";
        ...
        // }else{
        //      document.getElementById('msg_box').innerHTML = "<div class='alert alert-danger' role='alert'><span class='center-block'>" + "MAX QTY : "+document.getElementById('to_be_issued').value + "</span></div>";
        //       $("#msg_box").hide().slideDown(200).delay(1500);
        //       $("#msg_box").slideUp(200);
        //     // alert("MAX QTY : "+document.getElementById('to_be_issued').value);
...
//        alert(xmlHttp.responseText);
        ...
        document.getElementById('issue').value = XMLAddress1[0].childNodes[0].nodeValue;

        var alcated = XMLAddress1[0].childNodes[0].nodeValue;

        var tot = document.getElementById('total_allocated').value; 
        var recent_tot = document.getElementById('already_issued').value; 

            var tempbal = tot - recent_tot;
            tempbal = tempbal - alcated;
        document.getElementById('to_be_issued').value = tempbal.toFixed(2);        
...
function save_inv() {
    ...
    url = url + "&manuel_ref=" + document.getElementById('manuel_ref').value;
    var pro_des = document.getElementById('Product').value;
    pro_des = pro_des.replace("'", " FT");
    pro_des = pro_des.replace("'", " FT");
    pro_des = pro_des.replace("'", " FT");
    pro_des = pro_des.replace("'", " FT");
    pro_des = pro_des.replace("'", " FT");
    url = url + "&Product=" + pro_des;
...
function checkQTY() {
    // alert("fduyuy");
    var num1 = parseFloat(document.getElementById("to_be_issued").value) || 0;
    var num2 = parseFloat(document.getElementById("qty").value) || 0;
