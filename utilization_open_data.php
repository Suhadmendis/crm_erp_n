...
if ($_GET["Command"]=="settle_inv"){
	...
	$sql="select * from s_salma where C_CODE='".$_GET["Txtcusco"]."' and TOTPAY<GRAND_TOT and (GRAND_TOT-TOTPAY)>0 and CANCELL=0  ORDER BY SDATE";
...
if($_POST["Command"]=="save_crec")
{
	...
	if($row_utmas = mysql_fetch_array($result_utmas)){
		exit("Ref. No Already Exists".$sql_utmas);
	}
