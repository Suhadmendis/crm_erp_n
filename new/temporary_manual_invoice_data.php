...
if ($_GET["Command"] == "save_item") {
    ...
    try {
        ...
        $sqlno = "SELECT temporary_manual_invoice_code FROM inv_data";
        ...
        $sql = "Insert into temporary_manual_invoice(Invoice_Number,Invoice_Date,Settlement_Due,Customer_Order_No,ouraodnumber,Currency,Customer_Name,Customer_Address,Advance,NBT,VAT,SVAT,svatboo,vatboo,nbtboo,rate,yes,no)values 
        ('" . $no . "','" . $_GET['Invoice_Date'] . "','" . $_GET['Settlement_Due'] . "','" . $_GET['Customer_Order_No'] . "','" . $_GET['ouraodnumber'] . "','" . $_GET['Currency'] . "','" . $_GET['Customer_Name'] . "','" . $_GET['Customer_Address'] . "','" . $_GET['Advance'] . "','" . $_GET['NBT'] . "','" . $_GET['VAT'] . "','" . $_GET['SVAT'] . "','" . $_GET['svatboo'] . "','" . $_GET['vatboo'] . "','" . $_GET['nbtboo'] . "','" . $_GET['rate'] . "','" . $_GET['yes'] . "','" . $_GET['no'] . "')";
        $result = $conn->query($sql);

        $sql2 = "select * from temporary_manual_invoice_table_temp where Invoice_Number = '" . $_GET['Invoice_Number'] . "' and uniq = '" . $_GET['uniq'] . "'";


        foreach ($conn->query($sql2) as $row) {
            $des = str_replace("'", "\'", $row['Description']);
            $des = str_replace("$", "&amp;", $des);
            $sql = "Insert into temporary_manual_invoice_table(Invoice_Number,QTY,Description,Unit_Price,Value,vat,uniq)values 
        ...
        foreach ($conn->query($sql2) as $row) {
            ...
            $sql = "DELETE FROM temporary_manual_invoice_table_temp WHERE Invoice_Number = '" . $row['Invoice_Number'] . "' and uniq = '" . $_GET['uniq'] . "'";
            $result = $conn->query($sql);
        }
        ...
        $sql = "SELECT temporary_manual_invoice_code FROM inv_data";
        $resul = $conn->query($sql);
        $row = $resul->fetch();
        $no = $row['temporary_manual_invoice_code'];
        $no2 = $no + 1;
        $sql = "update inv_data set temporary_manual_invoice_code = $no2 where temporary_manual_invoice_code = $no";
        $result = $conn->query($sql);
...
if ($_GET["Command"] == "setitem") {
    ...
    if ($_GET["Command1"] == "add_tmp") {
        ...
        $sql = "Insert into temporary_manual_invoice_table_temp(Invoice_Number,QTY,Description,Unit_Price,Value,uniq)values 
    ...
    $sql1 = "SELECT * FROM temporary_manual_invoice_table_temp WHERE Invoice_Number = '" . $_GET['Invoice_Number'] . "' and uniq = '" . $_GET['uniq'] . "'";
...
if ($_GET["Command1"] == "add_tmpp") {
    ...
    try {
        ...
        $sql = "Insert into temporary_manual_invoice_table_temp(QTY,Description,Unit_Price,Value)values 
...
if ($_GET["Command"] == "removerow") {
    ...
    $sql = "delete from temporary_manual_invoice_table_temp where id = '" . $_GET['id'] . "'";
    $result = $conn->query($sql);
...
if ($_GET["Command"] == "delete") {
    ...
    $sql = "delete from temporary_manual_invoice where Invoice_Number = '" . $_GET['Invoice_Number'] . "'";
    $result = $conn->query($sql);

    $sql = "delete from temporary_manual_invoice_table where Invoice_Number = '" . $_GET['Invoice_Number'] . "'";
    $result = $conn->query($sql);
    echo "Deleted";
}
