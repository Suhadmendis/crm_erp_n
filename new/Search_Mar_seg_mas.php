...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" href="css/bootstrap.min.css">
            ...
            <script language="JavaScript" src="js/Search_Mar_seg_mas.js"></script>
    ...
    <body>
        ...
        <div id="filt_table" class="CSSTableGenerator">  <table width="735"   class="table table-bordered">
                ...
                <?php
                $sql = "SELECT * from mar_seg_mas";


                $sql = $sql . " order by seg_code limit 50";
                ...
                foreach ($conn->query($sql) as $row) {
                    $cuscode = $row['seg_code'];
                    echo "<tr> 
                             
                              <td onclick=\"custno('$cuscode');\">" . $row['seg_code'] . "</a></td>
                              <td onclick=\"custno('$cuscode');\">" . $row['seg_name'] . "</a></td>
