                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <td>
                            <select type="text" placeholder="Tax" id="tax" class="form-control input-sm">

                                <option class="form-control input-sm" value="1">NBT 2% + VAT 15%</option>
                                <option class="form-control input-sm" value="2">SVAT</option>
                                <option class="form-control input-sm" value="3">NBT 1% + VAT 15%</option>
                                <option class="form-control input-sm" value="4">VAT 15%</option>
                                <option class="form-control input-sm" value="5">NBT 2%</option>
                                <option class="form-control input-sm" value="6">NBT 1%</option>
                                <option class="form-control input-sm" value="7">NBT 2 % + SVAT</option>
                                <option class="form-control input-sm" value="8">NBT 1 % + SVAT</option>
                            </select>
                        </td>
