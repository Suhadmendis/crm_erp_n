    ...
    <div class="box box-primary">
        ...
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="invno">Job Request No</label>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('search_quotation.php?stname=job_rec', 'mywin', '800', '700', 'yes', 'center');
                                return false" href="">
                            <input type="button" class="btn btn-default" value="..."  name="searchcust">
                        </a>
                    </div>
                    ...
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('serach_customer.php?stname=jbr', 'mywin', '800', '700', 'yes', 'center');
                                return false" href="">
                            <input type="button" class="btn btn-default" value="..."  name="searchcust">
                        </a>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <label  class="col-sm-3 control-label hidden text-center"  for="invno">JR Qty</label>
                    <div class="col-sm-2">
                        <input type="text" id="JR_Qty" name="" placeholder="JR Qty" class="form-control hidden input-sm">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" placeholder="Marketing Ex Name" id="Marketing_name" class="form-control  input-sm">
                    </div>
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('search_sales_executive_master.php?stname=job_rec', 'mywin', '800', '700', 'yes', 'center');
                                return false" href="">
                            <input type="button" class="btn btn-default" value="..."  name="searchcust">
                        </a>
                    </div>
