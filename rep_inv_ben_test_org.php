  ...
  <?php 
		...
		while ($row1 = mysql_fetch_array($result1)){
			...
			if (($VAT_per=="1") or ($VAT_per=="2")){
				...
				echo "<tr><td><span width=100  class=\"style4\">p".$row_item["PART_NO"]."</span></td>
						<td><span width=500  class=\"style4\">".$row_item["BRAND_NAME"]." ".$row_item["STK_NO"]." ".$row_item["DESCRIPT"]."</span></td>
						<td align=\"right\"  width=50><span  class=\"style4\">".number_format($row1["QTY"], 2, ".", ",")."</span></td>
						<td  align=\"right\"  width=100><span  class=\"style4\">".number_format($PRICE, 2, ".", ",")."</span></td>
						
						<td align=\"right\"  width=50><span  class=\"style4\"></span></td>
						<td align=\"right\"  width=50><span  class=\"style4\"></span></td>";
				...
				echo "<td align=\"right\"><span class=\"style4\"></span></td>";
			//}
			echo "</tr>";
