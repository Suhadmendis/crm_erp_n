...
<html lang="en">
    <head>
        <title>GOOD RECEIVED NOTE Entry - Dummy</title>
                    ...
                    <div class="box box-primary">
                        ...
                        <form name= "form1" role="form" class="form-horizontal">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Reference No</label>
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="Reference No" id="ref_txt" class="form-control  input-sm">
                                        </div>  
                                        ...
                                        <div class="col-sm-2">
                                            <input type="date" placeholder="Date" id="date_txt" class="form-control  input-sm dt">
                                        </div>  
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">PO No</label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="PO No" id="po_txt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Currency Code</label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Currency Code" id="cur_txt" class="form-control  input-sm">
                                        </div> 
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Exchange Rate</label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Exchange Rate" id="ex_txt" class="form-control  input-sm">
                                        </div> 
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Supplier Code</label>
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="Supplier Code" id="supC_txt" class="form-control  input-sm">
                                        </div> 
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Supplier Name" id="supN_txt" class="form-control  input-sm">
                                        </div> 
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Cost Center</label>
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="Cost Center code" id="costC_txt" class="form-control  input-sm">
                                        </div> 
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Cost Center name" id="costN_txt" class="form-control  input-sm">
                                        </div>
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Remark</label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Remark" id="rem_txt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Tax Combination Code</label>
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="Tax Combination Code" id="taxC_txt" class="form-control  input-sm">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Tax Combination Name" id="taxN_txt" class="form-control  input-sm">
                                        </div>
                                    </div>
                                ...
                                <script src="js/GRNEntry.js"></script>
                                <script>
                                                        //         new_inv();
                                </script>
                                <!-- Modal -->
