...
function print_inv(cdata) {
    alert(document.getElementById('tmpno').value);
...
function myfun(x) {
    ...
    var num2 = parseFloat(document.getElementById("qty" + x.rowIndex).innerHTML) || 0;
    var tot = num2 - num1;
    if (num1 <= num2) {
        ...
        document.getElementById("user" + x.rowIndex).innerHTML = 0;
    }
