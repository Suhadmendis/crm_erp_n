...
if ($_GET["Command"] == "save_item") {
    ...
    try {
        ...
        $sql = "delete from po_req_dum where ref_no = '" . $_GET['ref_no'] . "'";
        $result = $conn->query($sql);



        $sql = "Insert into po_req_dum (ref_no,date,mau_no,remark)values 
    ('" . $_GET['ref_no'] . "', '" . $_GET['date'] . "', '" . $_GET['mau_no'] . "', '" . $_GET['remark'] . "') ";
