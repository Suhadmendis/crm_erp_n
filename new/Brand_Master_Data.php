...
if ($_GET["Command"] == "save_item") {
    ...
    try {
        ...
        $sql = "delete from brandMaster where code = '" . $_GET['code'] . "'";
        $result = $conn->query($sql);



        $sql = "Insert into brandMaster (code,c_name,cust_one,cust_two)values 
    ('" . $_GET['code'] . "', '" . $_GET['name'] . "', '" . $_GET['cus1'] . "', '" . $_GET['cus2'] . "') ";
