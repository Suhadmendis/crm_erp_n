...
function update_list_simple(stname)
{   
			...
			var url="cash_rec_data.php";			
			url=url+"?Command="+"search_rec_simple";
			url=url+"&mstatus="+stname;
			...
			xmlHttp.onreadystatechange=result_update_list_simple;
			xmlHttp.open("GET",url,true);
			xmlHttp.send(null);
	
}

function result_update_list_simple()
{
	var XMLAddress1;
...
function recnoSimple(recno, stname)
{   
			...
			var url="cash_rec_data.php";			
			url=url+"?Command="+"pass_recno_simple";
			url=url+"&recno="+recno;
			url=url+"&txtrefno="+opener.document.getElementById("txtrefno").value;
			//alert(url);
					
			xmlHttp.onreadystatechange=result_recno_simple;
			xmlHttp.open("GET",url,true);
			xmlHttp.send(null);
