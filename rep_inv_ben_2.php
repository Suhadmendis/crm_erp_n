  ...
  <tr>
    <td height="110" colspan="3" valign="top"><table border="0" bordercolor="#000000" cellpadding="0" cellspacing="0"><tr><td width="428"><table width="500" border="0" >
        <tr>
          ...
          <td width="8">&nbsp;</td>
          <td width="443"><span class=""><?php  echo $rtxtSupName;  ?></span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
  ...
  <?php 
		...
		while ($row1 = mysql_fetch_array($result1)){
			...
			if (($VAT_per=="1") or ($VAT_per=="2")){
				...
				echo "<tr><td><span width=100  class=\"\">".$row_item["PART_NO"]."</span></td>
						<td><span width=500  class=\"\">".$row_item["BRAND_NAME"]." ".$row_item["STK_NO"]." ".$row_item["DESCRIPT"]."</span></td>
						<td align=\"right\"  width=50><span  class=\"\">".number_format($row1["QTY"], 0, ".", ",")."</span></td>
						<td  align=\"right\"  width=100><span  class=\"\">".number_format($PRICE, 2, ".", ",")."</span></td>
						
						<td align=\"right\"  width=50><span  class=\"\"></span></td>
						<td align=\"right\"  width=50><span  class=\"\"></span></td>";
			
						$discount1=$PRICE*$row1["QTY"]*$row1["DIS_per"]/100;
						$subtot=($PRICE*$row1["QTY"])-$discount1;
				echo "<td align=\"right\"  width=100><span  class=\"\">&nbsp;&nbsp;&nbsp;&nbsp;".number_format($subtot, 2, ".", ",")."</span></td>";
  ...
  <tr>
    ...
    <td align="right"><b>
      ...
      <table width="250" border="0">
        <tr>
          <td width="175" align="right"><b><span class="">
