...
function caldis(i)
{
	...
	var Incen_per = "Incen_per" + i;
   	document.getElementById(Incen_val).value = document.getElementById(Amount).value *  (document.getElementById(Incen_per).value /100);
...
{   
	...
	if (document.getElementById('txtrefno').value==""){
		...
		if( document.getElementById('lock').innerHTML==""){
			...
			params=params+"&txtrefno="+document.getElementById('txtrefno').value;
			...
			params=params+"&Com_rep="+document.getElementById('Com_rep').value;
			params=params+"&MonthView1="+document.getElementById('MonthView1').value;
			...
			while (i<document.getElementById('mcou').value){
				...
				params=params+"&"+Inv_date+"="+document.getElementById(Inv_date).value;
				params=params+"&"+inv_no+"="+document.getElementById(inv_no).value;
				params=params+"&"+Amount+"="+document.getElementById(Amount).value;
				params=params+"&"+settleamt+"="+document.getElementById(settleamt).value;
				params=params+"&"+settledate+"="+document.getElementById(settledate).value;
				params=params+"&"+days+"="+document.getElementById(days).value;
				params=params+"&"+Incen_per+"="+document.getElementById(Incen_per).value;
				params=params+"&"+Incen_val+"="+document.getElementById(Incen_val).value;
				params=params+"&"+disc1+"="+document.getElementById(disc1).value;
...
function assign_invno(){
  ...
  if(xmlHttp.responseText=="no"){
	...
	document.getElementById('txtremark').value="DISCOUNTS AMOUNTS";	
