...
if ($_GET["Command"] == "save_item") {
    ...
    try {
        ...
        $result = $conn->query($sql);
              ...
              $sql = "Insert into joborder(jid,joborderref,jobdate,QuotationRef,CostingRef,JobRequestRef,ManualRef,Customer,jobnew,jrepeat,MarketingEx,RepeatPreviousJBNRef,ProductDescription,Instructions,CustomerPONo,JobQty,Location,SalesPrice,TotalValue,joblength,jobwidth,NoofColors,NoofImp,trf_qty,Noofsides,Noofouts,inkCode,inkDes,Ink_Was,all_pro,No_of_sides,No_of_outs)values
                        ('" . $_GET['jcode'] . "','" . $_GET['joborderref'] . "','" . $_GET['jdate'] . "','" . $_GET['QuotationRef'] . "','" . $_GET['CostingRef'] . "','" . $_GET['JobRequestRef'] . "','" . $_GET['ManualRef'] . "','" . $_GET['Customer'] . "','" . $_GET['jnew'] . "','" . $_GET['jrepeat'] . "','" . $_GET['MarketingEx'] . "','" . $_GET['RepeatPreviousJBNRef'] . "','" . $_GET['ProductDescription'] . "','" . $_GET['Instructions'] . "','" . $_GET['CustomerPONo'] . "','" . $_GET['JobQty'] . "','" . $_GET['Location'] . "','" . $_GET['SalesPrice'] . "','" . $_GET['TotalValue'] . "','" . $_GET['jlength'] . "','" . $_GET['jwidth'] . "','" . $_GET['NoofColors'] . "','" . $_GET['NoofImpressions'] . "','" . 0 . "','" . $_GET['Noofsides'] . "','" . $_GET['Noofouts'] . "','" . $_GET['inkCode'] . "','" . $_GET['inkDes'] . "','" . $_GET['Ink_Was'] . "','" . $_GET['all_pro'] . "','" . $_GET['No_of_sides'] . "','" . $_GET['No_of_outs'] . "')";
        $result = $conn->query($sql);
