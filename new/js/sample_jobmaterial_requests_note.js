...
function newent() {
    document.getElementById('sjb_txt').value = "";
    document.getElementById('date_txt').value = "";
    document.getElementById('sjbmrn_txt').value = "";
...
function getdt() {
    ...
    var url = "sample_jobmaterials_request_note_data.php";
...
function assign_dt() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        document.getElementById('sjb_txt').value = XMLAddress1[0].childNodes[0].nodeValue;
...
function save_inv() {
    ...
    document.getElementById('msg_box').innerHTML = "";
    if (document.getElementById('sjb_txt').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Job Materials Req. No. Not Enterd</span></div>";
        return false;
    }
    ...
    url = url + "&sjb_txt=" + document.getElementById('sjb_txt').value;
    url = url + "&date_txt=" + document.getElementById('date_txt').value;
    url = url + "&sjbmrn_txt=" + document.getElementById('sjbmrn_txt').value;
