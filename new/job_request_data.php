...
if ($_GET["Command"] == "new_inv") {
    ...
    $ResponseXML .= "<tmpno><![CDATA[" . uniqid() . "]]></tmpno>";
...
//        exit ($sql);
        ...
        $sql1 = "insert into s_jobreq(SDATE, REF_NO,  tmp_no,  remark,cus_code,QUO_NO,COST_NO,mark_ex,pro_des,jr_qty,new_or_repeat,Manual_No) values ('" . $_GET["invdate"] . "', '" . $invno . "',  '" . $_GET["tmpno"] . "',  '" . $_GET["txt_remarks"] . "',  '" . $_GET["cusText"] . "','" . $_GET["quotation_id"] . "','" . $_GET["costing_id"] . "','" . $_GET["mark_ex"] . "','" . $_GET["pro_des"] . "','" . $_GET["jr_qty"] . "','" . $_GET["new_or_repeat"] . "','" . $_GET["Manual_No"] . "')";
