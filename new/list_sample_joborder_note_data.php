...
//
    ...
    $sql2 = "select * from samplejoborder";
    ...
    $tb .= "<thead><tr>";
    $tb .= "<th>SJ Request No.</th>";
    $tb .= "<th>Job Order Date</th>";
    $tb .= "<th>Customer</th>";
    $tb .= "<th>Mk. Ex</th>";
    $tb .= "<th>SJB Ref.</th>";
...
//        }
        ...
        $tb .= "<tr>               
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['SJRequestNo'] . "</a></td>
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['jodate'] . "</a></td>
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['customer'] . "</a></td>
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['mkex'] . "</a></td>                              
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['sjbref'] . "</a></td></tr>";
