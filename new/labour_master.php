...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><b>Labour Master</b></h3>
        </div>
            ...
            <div class="box-body">
                ...
                <div class="form-group-sm">
                    ...
                    <a  onclick="save_inv();" class="btn btn-success btn-sm">
                     ...
                     <a onclick="NewWindow('search_overheads.php?stname=lab', 'mywin', '800', '700', 'yes', 'center');" class="btn btn-info btn-sm">
...
<script src="js/labour_master.js"></script>
