...
<style>
    * { margin: 0; padding: 0; }
    ...
    textarea { border: 0; font: 14px Georgia, Serif; resize: none; }
...
$sql2 = "SELECT * FROM temporary_manual_invoice where Invoice_Number = '$mid'";
...
foreach ($conn->query($sql2) as $row3) {
    ...
    $genid = "";
    if (strlen($id) == 1) {
        $id = "ccs/Temp/19-0000" . $id;
    } else if (strlen($id) == 2) {
        $id = "ccs/Temp/19-000" . $id;
    } else if (strlen($id) == 3) {
        $id = "ccs/Temp/19-00" . $id;
    } else if (strlen($id) == 4) {
        $id = "ccs/Temp/19-0" . $id;
    }
...
<div id="middle" style="margin-left: 200px;"><br><br><br><br><br><b id="top">' . $v . '</b></div>
...
<br>';
    ...
    $sql12 = "SELECT count(Invoice_Number) FROM temporary_manual_invoice_table where Invoice_Number = '$mid'";
    $result = $conn->query($sql12);
    $row = $result->fetch();
    $rowcount = $row[0];

    if ($rowcount > 16) {
        echo '<p style="position: absolute;margin-left: 400px;margin-up: 20;margin-top: 750px;">Page 1</p>';
        echo '<p style="position: absolute;margin-left: 400px;margin-up: 20;margin-top: 1850px;">Page 2</p>';
    }
...
<table id="items" style="table-layout: fixed;"><thead>
    ...
    $sql3 = "SELECT * FROM temporary_manual_invoice_table where Invoice_Number = '$mid'";
    ...
    $subtotsql = "SELECT SUM(Value) FROM temporary_manual_invoice_table where Invoice_Number = '$mid'";
    $ad = "SELECT SUM(Advance) FROM temporary_manual_invoice where Invoice_Number = '$mid'";
