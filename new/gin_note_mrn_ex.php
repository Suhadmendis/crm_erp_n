        ...
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <a style="float: right;margin-right: 10px;" onclick="NewWindow('list_mrn.php?stname=mrn_ex', 'mywin', '1920', '1080', 'yes', 'center');" class="btn btn-info btn-sm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('search_joborder.php?stname=mrn_ex', 'mywin', '800', '700', 'yes', 'center');
                                return false" href="">
