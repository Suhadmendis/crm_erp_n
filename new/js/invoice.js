...
function save_inv(status) {
    ...
    if (document.getElementById('c_code').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Customer Ref Not Selected</span></div>";
        return false;
    }
    ...
    url = url + "&txt_fg=" + document.getElementById('txt_fg').value;
    url = url + "&txt_job=" + document.getElementById('txt_job').value;
    url = url + "&txt_costing=" + document.getElementById('txt_costing').value;
    ...
    url = url + "&vendor_code=" + document.getElementById('vendor_code').value;

    url = url + "&C_NBT=" + document.getElementById('C_NBT').value;
    url = url + "&C_VAT=" + document.getElementById('C_VAT').value;
    url = url + "&C_SVAT=" + document.getElementById('C_SVAT').value;
