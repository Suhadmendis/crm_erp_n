...
function newent() {
    ...
    document.getElementById('manualrefno_txt').value = "";
    document.getElementById('pono_txt').value = "";
    document.getElementById('currencycode_txt').value = "";
    document.getElementById('exchange_txt').value = "";
    document.getElementById('suppliercodeno_txt').value = "";
...
function getdt() {
    ...
    var url = "GRN_Stores_GT_Data.php";
