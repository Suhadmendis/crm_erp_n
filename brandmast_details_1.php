                        ...
                        <div class="CSSTableGenerator" id="itemdetails" >
                            <div id="bank_table">
                                ...
                                <table border="1" cellspacing="0">
                                    <?php
                                    echo "<tr>
                              <td width=\"121\"  background=\"images/headingbg.gif\" ><font color=\"#FFFFFF\">ID</font></td>
                              <td width=\"424\"  background=\"images/headingbg.gif\"><font color=\"#FFFFFF\">Brand Name</font></td>
							    
   							</tr>";


                                    $sql = "select * from brand_mas_new order by brand_name";
                                    $result = $db->RunQuery($sql);
                                    while ($row = mysql_fetch_array($result)) {

                                        echo "<tr>
                                            	<td width=\"155\" onclick=\"bankno('" . $row['brand_name'] . "', '" . $row['id'] . "');\">" . $row["id"] . "</td>
                                            	<td width=\"155\" onclick=\"bankno('" . $row['brand_name'] . "', '" . $row['id'] . "');\">" . $row["brand_name"] . "</td></tr>";
                                    }
                                    ?>
