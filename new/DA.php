...
<html lang="en">
    <head>
        <title>Designer Allocation</title>
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><b> DESIGNER ALLOCATION</b></h3>
                        </div>
                        <form name= "form1" role="form" class="form-horizontal">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Ref No</label>
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="Ref No" id="refTxt" class="form-control  input-sm">
                                        </div>  
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; " for="invno"></label>
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Date</label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">DRF No</label>
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="DRF No" id="drfTxt" class="form-control  input-sm">
                                        </div> 
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Marketing Excecutive</label>
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="Mr Ec Code" id="mrExCodeTxt" class="form-control  input-sm">
                                        </div> 
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Mr Ex Name" id="mrExNameTxt" class="form-control  input-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Customer</label>
                                        <div class="col-sm-2">
                                            <input type="text" placeholder="Code" id="cusCodeTxt" class="form-control  input-sm">
                                        </div>
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Customer Code" id="cusNameTxt" class="form-control  input-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Product Des</label>
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="Product Des" id="proDesTxt" class="form-control  input-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">At Work Path</label>
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="At Work Path" id="wrkPathTxt" class="form-control  input-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Concept Path</label>
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="Concept Path" id="conPathTxt" class="form-control  input-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Costing & Specification Path</label>
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="Costing & Specification Path" id="cosPathTxt" class="form-control  input-sm">
                                        </div>
                                    </div>
                                     
                                     <div class="form-group"></div>
                                     
                                     <h1 style="font-size: 20px; ">Designer Detail</h1>
