...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Search Product Group</title>
        <link rel="stylesheet" href="css/bootstrap.min.css">

            <script language="JavaScript" src="js/Search_productG.js"></script>
    ...
    <body>
        ...
        <div id="filt_table" class="CSSTableGenerator">  <table width="735"   class="table table-bordered">
                ...
                <?php
                $sql = "SELECT * from master_pgroup";


                $sql = $sql . " order by g_code limit 50";
                ...
                foreach ($conn->query($sql) as $row) {
                    ...
                    echo "<tr> 
                              ...
                              <td onclick=\"custno('$cuscode');\">" . $row['g_code'] . "</a></td>
                              <td onclick=\"custno('$cuscode');\">" . $row['g_name'] . "</a></td>
