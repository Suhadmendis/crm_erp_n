...
//
    ...
    $sql2 = "select * from samplejobmatirealissue";
...
//        }
        ...
        $tb .= "<tr>               
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['sjbno'] . "</a></td>
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['mrnref'] . "</a></td>
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['issueddate'] . "</a></td>  
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['minref'] . "</a></td>  
                               <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['manualref'] . "</a></td>  
                              <td rowspan=\"\" onclick=\"custno('$cuscode');\">" . $row['remarks'] . "</a></td></tr>";
