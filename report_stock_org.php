...
function selling()
{
	...
	$db = new DBConnector();
	    ...
	    if ($_GET["brand"] != "All") { 
			if ($_GET["cat"] != "All") { 
				$sql = "select * from s_mas where BRAND_NAME='".$_GET["brand"]."' and CAT='".$_GET["cat"]."' and QTYINHAND!=0 and COST!=0 ORDER BY DESCRIPT, GROUP1, model, GROUP2 ";
			} else {
				$sql = "select * from s_mas where BRAND_NAME='".$_GET["brand"]."' and QTYINHAND!=0 and COST!=0 ORDER BY DESCRIPT, GROUP1, model, GROUP2 ";
			}
		}	
        if ($_GET["brand"] == "All") { 
			if ($_GET["cat"] != "All") { 
				$sql = "select * from s_mas where CAT='".$_GET["cat"]."' and QTYINHAND!=0 and COST!=0 ORDER BY BRAND_NAME, DESCRIPT, GROUP1, model, GROUP2 ";
			} else {
				$sql = "select * from s_mas where QTYINHAND!=0 and COST!=0 ORDER BY BRAND_NAME, DESCRIPT, GROUP1, model, GROUP2 ";
			}
		}	
...
function print_rep()
{
	...
	if ($_GET["brand"] == "All") { 
		if ($_GET["cat"] != "All") { 
	 		$sql = "select * from s_mas where CAT='".$_GET["cat"]."' and QTYINHAND!=0 and brand_name !='Dag CustomeDag Customerr' and brand_name !='Dag Customer' and brand_name !='Dag Custormer' and brand_name !='Dag Sale' ORDER BY BRAND_NAME, DESCRIPT, GROUP1, model, GROUP2 "; 
		} else {
			$sql = "select * from s_mas where QTYINHAND!=0 and brand_name !='Dag CustomeDag Customerr' and brand_name !='Dag Customer' and brand_name !='Dag Custormer' and brand_name !='Dag Sale' ORDER BY BRAND_NAME, DESCRIPT, GROUP1, model, GROUP2 ";
		}
	}		
