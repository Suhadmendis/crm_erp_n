            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        ...
                        <label  class="col-sm-1 control-label" ><input type="radio" id="non" onchange="changeID();" name="optradio" value="non">&nbsp;Direct</label>

                        <label  class="col-sm-1 control-label" ><input type="radio" id="svat" onchange="changeID();" name="optradio" value="svat" checked="">&nbsp;Normal</label>
