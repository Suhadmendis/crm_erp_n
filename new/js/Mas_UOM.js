...
function newent() {
    ...
    document.getElementById('uom_code_txt').value = "";
    document.getElementById('uom_name_txt').value = "";
    document.getElementById('inches_txt').value = "";
...
function save_inv() {
    ...
    if (document.getElementById('uom_code_txt').value == "") {
    ...
    if (document.getElementById('uom_name_txt').value == "") {
...
//    }
    ...
    url = url + "&uom_code=" + document.getElementById('uom_code_txt').value;
    url = url + "&uom_name=" + document.getElementById('uom_name_txt').value;
    url = url + "&con_inch=" + document.getElementById('inches_txt').value;
