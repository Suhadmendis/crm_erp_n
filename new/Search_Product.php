...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" href="css/bootstrap.min.css">
            ...
            <script language="JavaScript" src="js/Search_Product.js"></script>
    ...
    <body>
        ...
        <div id="filt_table" class="CSSTableGenerator">  <table width="735"   class="table table-bordered">
                ...
                <?php
                $sql = "SELECT * from it_mas";


                $sql = $sql . " order by p_code limit 50";
                ...
                foreach ($conn->query($sql) as $row) {
                    ...
                    echo "<tr> 
                              ...
                              <td onclick=\"custno('$cuscode');\">" . $row['p_code'] . "</a></td>
                              <td onclick=\"custno('$cuscode');\">" . $row['p_name'] . "</a></td>
