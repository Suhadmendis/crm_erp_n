...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" href="css/bootstrap.min.css">
            ...
            <script language="JavaScript" src="js/Search_cost.js"></script>
    ...
    <body>
        ...
        <div id="filt_table" class="CSSTableGenerator">  <table width="735"   class="table table-bordered">
                ...
                <?php
                $sql = "SELECT * from master_cost";


                $sql = $sql . " order by cost_cen limit 50";
                ...
                foreach ($conn->query($sql) as $row) {
                    $cuscode = $row['cost_cen'];
                    echo "<tr> 
                             
                              <td onclick=\"custno('$cuscode');\">" . $row['cost_cen'] . "</a></td>
