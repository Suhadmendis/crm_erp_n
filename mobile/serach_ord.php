...
<tr>
  <td  background="" ><input type="radio" name="radio" id="Option1" value="Option1" checked="checked" onclick="update_list('$stname');" />
    Pending Order</td>
  <td width="179"  background="" ><input type="radio" name="radio" id="Option2" value="Option2" onclick="update_list('$stname');"/>
    To 
  MM</td>
  <td width="258"  background="" ><input type="radio" name="radio" id="Option3" value="Option3" onclick="update_list('$stname');"/>
    To WD</td>
