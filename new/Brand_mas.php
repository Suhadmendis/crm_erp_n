...
<!--                            <input type="text" name="q" class="form-control" placeholder="Search...">
            ...
            <div class="content-wrapper">
                        ...
                        <form name= "form1" role="form" class="form-horizontal">
                            ...
                            <div class="box-body">
                               ...
                               <input type="hidden" id="tmpno" class="form-control">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group-sm">
                                         <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Brand Code</label>
                                         <div class="col-sm-2">
                                            <input type="text" placeholder="Brand Code" id="gCodeTxt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                                         <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Brand Name</label>
                                         <div class="col-sm-6">
                                            <input type="text" placeholder="Brand Name" id="gNameTxt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                ...
                <script src="js/Brand_mas.js"></script>
                <script>
                                                new_inv();
                </script>
                <!-- Modal -->
