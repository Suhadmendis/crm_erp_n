...
function getdt() {
    ...
    var url = "search_adjustments_addition_deduction_data.php";
...
//        opener.document.getElementById('addition').value = XMLAddress1[0].childNodes[0].nodeValue;
        var addition =  XMLAddress1[0].childNodes[0].nodeValue;
        if(addition ==="1"){
           opener .document.getElementById('addition').checked = true;
        }else{
             opener .document.getElementById('addition').checked = false;
        }
        

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_customername2");
//        opener.document.getElementById('deduction').value = XMLAddress1[0].childNodes[0].nodeValue;
         var deduction =  XMLAddress1[0].childNodes[0].nodeValue;
         if(deduction ==="1"){
           opener .document.getElementById('deduction').checked = true;
        }else{
             opener .document.getElementById('deduction').checked = false;
        }
