...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td width="15%"><input type="text" name="invno" id="invno" value="" class="text_purchase3" onkeypress="keyset('searchcust',event);"  />
      <a href="serach_arn_3.php" onClick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onFocus="this.blur()">
  ...
  <tr>
    ...
    <td width="14%"><input type="text" name="orderno1" id="orderno1" value="" onkeypress="keyset('orderdate',event);" class="text_purchase3"/>
     <a href="search_purord_3.php?stname=arn" onClick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onFocus="this.blur()"><input type="button" name="searchord" id="searchord" value="..." class="btn_purchase1" ></a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
