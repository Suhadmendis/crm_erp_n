...
if ($_GET["Command"] == "new_rec") {
    ...
    if ($_SESSION["dev"] != "") {
        ...
        $sql = "select re_pay from invpara ";
        $result = $db->RunQuery($sql);
        $row = mysql_fetch_array($result);

        $tmprecno = "000000" . $row["re_pay"];
        $lenth = strlen($tmprecno);

        $recno = trim("CRC/19/") . substr($tmprecno, $lenth - 5);
...
//=============================================================================
	  ...
	  ('" . $recno . "', '" . $_POST["invdate"] . "', '" . $_POST["cuscode"] . "', " . $cashtot . ", " . $txtpaytot . ", " . $txtoverpay . ", 'REC', '" . $_POST["paytype"] . "', '" . $_POST["salesrep"] . "', '0', '" . $_SESSION["tmp_no_cashrec"] . "', 'O', '0', '" . $_POST["ca_refno"] . "', '" . $_POST["dt"] . "',  '" . $_SESSION['dev'] . "' , '" . $_SESSION['company'] . "', '" . $_POST['cus_remark'] . "')";
            //echo $sql;
            $result = mysql_query($sql, $dbinv);
            if ($result != 1) {
                $sql_status = 1;
...
*/
	  ...
	  ('" . $recno . "', '" . $_POST["invdate"] . "', 'REC', '" . $_POST["cuscode"] . "',  " . $_POST["txtoverpay"] . ", " . $_POST["txtoverpay"] . ", '" . $_POST["salesrep"] . "', '" . $_SESSION["dev"] . "', '".$mvatrate."', '".$_SESSION['company']."')";
            ...
            $sql2 = "update invpara set re_pay=re_pay + 1 ";
            $result2 = mysql_query($sql2, $dbinv);
            if ($result2 != 1) {
                $sql_status = 13;
            }
