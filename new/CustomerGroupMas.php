...
<html lang="en">
    <head>
        <title>Customer Group Master File</title>
...
<!--                            <input type="text" name="q" class="form-control" placeholder="Search...">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>Customer Group Master File</b></h3>
                        </div>
                        <form name= "form1" role="form" class="form-horizontal">
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-1 input-sm" style="text-align:  left; background-color: #5A687B;  color: white;" for="invno">Group Code</label>
                                        <div class="col-sm-1">
                                            <input type="text" placeholder="Group Code " id="gCodeTxt" class="form-control  input-sm ">
                                        </div> 
                                    ...
                                    <div class="form-group-sm" >
                                        <label class="col-sm-1 input-sm labelColour" style="text-align: left; background-color:#5A687B; margin-top: -12px;" for="invno">Group Name NO</label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Group Name" id="gNameTxt" class="form-control  input-sm ">
                                        </div>  
                ...
                <script src="js/CustomerGroupMas.js"></script>
                <script>
                                        new_inv();
                </script>
                <!-- Modal -->
