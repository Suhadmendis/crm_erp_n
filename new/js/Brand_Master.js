...
function save_inv() {
    ...
    if (document.getElementById('customerText').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Suppplier Name Not Selected</span></div>";
        return false;
    }
    if (document.getElementById('customer1Text').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-warning' role='alert'><span class='center-block'>Suppplier Name Not Selected</span></div>";
        return false;
    }
...
//    }
    ...
    url = url + "&name=" + document.getElementById('nameText').value;
    url = url + "&cus1=" + document.getElementById('customerText').value;
    url = url + "&cus2=" + document.getElementById('customer1Text').value;
