...
function newent() {
    ...
    document.getElementById('descritpionText').value = "";
...
function save_inv() {
    ...
    if (document.getElementById('descritpionText').value == "") {
    ...
    var url = "DailyVisitCategoryMaster_Data.php";
    ...
    url = url + "&category=" + document.getElementById('categoryText').value;
    url = url + "&description=" + document.getElementById('descritpionText').value;
