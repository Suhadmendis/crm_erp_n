                        ...
                        <form name= "form1" role="form" class="form-horizontal">
                            ...
                            <div class="box-body">
                               ...
                               <input type="hidden" id="tmpno" class="form-control">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group-sm">
                                         <label class="col-sm-2 input-sm labelColour" style="text-align: left; " for="invno">Marketing Ex Code</label>
                                         <div class="col-sm-2">
                                            <input type="text" placeholder="Marketing Ex Code" id="gCodeTxt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                                         <label class="col-sm-2 input-sm labelColour" style="text-align: left; " for="invno">Marketing Ex Name</label>
                                         <div class="col-sm-6">
                                            <input type="text" placeholder="Marketing Ex Name" id="gNameTxt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                ...
                <script src="js/Mar_seg_mas.js"></script>
                <script>
                                                new_inv();
                </script>
                <!-- Modal -->
