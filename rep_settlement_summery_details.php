...
<form id="form1" name="form1" action="./adv/report_settlement_summery.php" target="_blank" method="get">
<table width="928" border="0">
  ...
  <tr>
    <td width="208" align="left"><input type="text"  class="label_purchase" value="From" disabled="disabled"/></td>
  ...
  <tr>
    ...
    <td><input type="radio" name="radio" id="optret" value="optret"  />
              Return Cheque</td>
    <td colspan="2" style="visibility:hidden;"><input type="radio" name="radio" id="op_sales" value="op_sales"  />
              Sales  Collection</td>
  </tr>
  <tr>
    <td colspan="2" align="left">&nbsp;</td>
...
<!--    <td colspan="2" align="left"><table width="274">
      <tr>
        <td width="76" align="left"><input type="text"  class="label_purchase" value="Type" disabled="disabled"/></td>
        <td width="186"><select name="cmbtype" id="cmbtype" onkeypress="keyset('searchitem',event);" class="text_purchase3" >
          <option value="All">All</option>
  ...
  <tr>
        <td><input type="text"  class="label_purchase" value="Days 1" disabled/></td>
        <td><input type="text" value="30" name="days1" id="days1" class="text_purchase3"/></td>
      </tr>
      <tr>
        <td><input type="text"  class="label_purchase" value="Days 2" disabled/></td>
        <td><input type="text" value="60" name="days2" id="days2" class="text_purchase3"/></td>
      </tr>
      <tr>
        <td><input type="text"  class="label_purchase" value="Days 3" disabled/></td>
        <td><input type="text" value="90" name="days3" id="days3" class="text_purchase3"/></td>
      </tr> 
      <tr>
        <td><input type="text"  class="label_purchase" value="Days 4" disabled/></td>
        <td><input type="text" value="150" name="days4" id="days4" class="text_purchase3"/></td>
      </tr>
  <tr>
    <td colspan="2" align="left">&nbsp;</td>
