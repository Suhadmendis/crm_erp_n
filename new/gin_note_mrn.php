        ...
        <form name= "form1" role="form" class="form-horizontal">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <a style="float: right;margin-right: 10px;" onclick="NewWindow('list_mrn.php?stname=mrn', 'mywin', '1920', '1080', 'yes', 'center');" class="btn btn-info btn-sm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        ...
                        <input type="text" placeholder="Ref No" id="uniq" class="form-control hidden input-sm">
                    </div>
                    <div class="col-sm-1">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <a onfocus="this.blur()" onclick="NewWindow('search_joborder.php?stname=pickJOB', 'mywin', '800', '700', 'yes', 'center');
                                return false" href="">
                            <input type="button" class="btn btn-default" value="...">
                        </a>
                    </div>
                    <label class="col-sm-3 control-label" for="invdate">Product</label>
                    <div class="col-sm-3">
                ...
                <!--
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="" onclick="NewWindow('serach_item.php?stname=mrn', 'mywin', '800', '700', 'yes', 'center');
                                        ...
                                        <td>
                                            <input type="text" placeholder="Allocated Qty" id="allqty" class="form-control input-sm">
                                        </td>
                                        ...
                                        <td>
                                          ...
                                          <td>
                                            <input type="text" placeholder="Balance" id="bal" class="form-control input-sm">
                                        </td>
