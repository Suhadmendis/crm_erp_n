            ...
            if ($_GET["chkpe"] != "on") {
                if ($_GET["cmbdev"] == "All"){
                   if ($_GET["cmbrep"] == "All") { 
				   		...
				   		$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."') and CANCELL='0' order by C_CODE, SDATE";
						
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
					
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep."'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' order by C_CODE, SDATE";
				...
				if ($_GET["cmbdev"] == "Computer") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='0' order by C_CODE, SDATE";
                   	}
				   	if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep."'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='0' order by C_CODE, SDATE";
                	}
                }
                ...
                if ($_GET["cmbdev"] == "Manual") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'" .$tmpdate. "'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='1' order by C_CODE, SDATE";
					}	
                   	if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep. "'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='1'order by C_CODE, SDATE";
                	}
            	}
            }
			...
			if ($_GET["chkpe"] == "on") {
                if ($_GET["cmbdev"] == "All") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."'or SDATE='".$tmpbellow."')  and CANCELL='0' order by C_CODE, SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep. "'and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' order by C_CODE, SDATE";
					}	
               }
               ...
               if ($_GET["cmbdev"] == "Computer") {
                   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpover ."' or SDATE='".$tmpover."') and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='0' order by C_CODE, SDATE";
					}	
                   	
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep."' and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='0' order by C_CODE, SDATE";
               		}
				}
				...
				if ($_GET["cmbdev"] == "Manual") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpover."' or SDATE='".$tmpover."') and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='1' order by C_CODE, SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						//echo "12";
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep."' and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='1' order by C_CODE, SDATE";
                	}
            	}	
			}
    }    
            ...
            if ($_GET["chkpe"] != "on") {
                if ($_GET["cmbdev"] == "All") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpdate ."' or SDATE='".$tmpdate."') and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
                   	}
					if ($_GET["cmbrep"] != "All") { 
				   		
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
                	}
               }
			   ...
			   if ($_GET["cmbdev"] == "Computer") {
                    if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                    if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
                	}
				}
                ...
                if ($_GET["cmbdev"] == "Manual") {
				   ...
				   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "') and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
				   }	
                   if ($_GET["cmbrep"] != "All") { 
				   		
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
                   }
            	}
            }
			...
			if ($_GET["chkpe"] == "on") {
                if ($_GET["cmbdev"] == "All") {
                   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "')  and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                }
                ...
                if ($_GET["cmbdev"] == "Computer") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0'and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                }
                ...
                if ($_GET["cmbdev"] == "Manual") {
                   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                    if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1'  and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                }
            }
 	}
  ...
  echo $sql;
   ...
   $row_head = mysql_fetch_array($result_head);
	...
	if ($_GET["cmbbrand"] == "All") {
    	if ($_GET["cmbdev"] == "All") {
        	if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and CANCELL='0'";
			}	
        	
			if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and SAL_EX='" . $rep . "'  and CANCELL='0'";
			}	
    	}
    
    	if ($_GET["cmbdev"] == "Manual") {
        	if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and DEV='1'  and CANCELL='0' ";
			}	
        	
			if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and SAL_EX='" . $rep . "' and DEV='1'  and CANCELL='0' ";
			}
		}		
        
    	if ($_GET["cmbdev"] == "Computer") {
        	if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and DEV='0'  and CANCELL='0' ";
			}	
        	
			if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and SAL_EX='" . $rep . "' and DEV='0'  and CANCELL='0'";
			}	
    	}
	}
   ...
   $date=date("Y-m-d");
	...
	$tmpdate=date('Y-m-d', strtotime($date.$caldays));
   	...
   	if ($_GET["cmbbrand"] != "All"){
    	if ($_GET["cmbdev"] == "All") {
        	if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        	
			if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and SAL_EX='" . $rep . "'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
    	}
    
    	if ($_GET["cmbdev"] == "Manual") {
        	if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and DEV='1'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
        	if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and SAL_EX='" . $rep . "' and DEV='1'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
    	}
    
    	if ($_GET["cmbdev"] == "Computer") {
        	if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and DEV='0'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
        	if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as over120 from s_salma where  GRAND_TOT > TOTPAY and SDATE<'" . $tmpdate . "' and SAL_EX='" . $rep . "' and DEV='0'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
    	}
	}
   ...
   if ($_GET["cmbbrand"] == "All") {
   		if ($_GET["cmbdev"] == "All") {
        	if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "'  and CANCELL='0' ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . $rep . "'  and CANCELL='0'";
			}
        }
        
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='0'  and CANCELL='0' ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . $rep . "' and DEV='0'  and CANCELL='0' ";
			}	
        }
        
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='1' and CANCELL='0' ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . $rep . "'and DEV='1'  and CANCELL='0'";
			}	
        }
	}
   ...
   if ($_GET["cmbbrand"] != "All") {
        if ($_GET["cmbdev"] == "All") {
            if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . $rep . "'  and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
        
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='0'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . $rep . "' and DEV='0'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
        
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='1' and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t90to120 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . $rep . "'and DEV='1'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
	}	
	...
	if ($_GET["cmbbrand"] == "All") {
        if ($_GET["cmbdev"] == "All") {
            if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "'  and CANCELL='0' ";
			}	
            if ($_GET["cmbrep"] != "All") {
			 	$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . $rep . "'  and CANCELL='0'";
			}
        }
        
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='0'  and CANCELL='0'";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . rep . "' and DEV='0'  and CANCELL='0' ";
			}	
        }
        
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='1'  and CANCELL='0' ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . rep . "' and DEV='1'   and CANCELL='0'";
			}	
        }
	}
	...
	if ($_GET["cmbbrand"] != "All") {
        if ($_GET["cmbdev"] == "All") {
            if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . rep . "'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
        
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='0'  and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . rep . "' and DEV='0'  and CANCELL='0'   and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
        
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and DEV='1'  and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$rst1= "SELECT sum(GRAND_TOT)-sum(totpay) as t60to90 from s_salma where  GRAND_TOT > TOTPAY and SDATE>'" . $tmpdate . "' and  SDATE<'" . $tmpdate2 . "' and SAL_EX='" . rep . "' and DEV='1'   and CANCELL='0'  and Brand='" . $_GET["cmbbrand"] . "'";
        	}
		}
	}	
...
function currentrepcus()
{
	...
	if ($_GET["cmbbrand"] == "All") {
        if ($_GET["cmbdev"] == "All") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and CANCELL='0' group by C_CODE ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' group by C_CODE";
			}
        }
         
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='1'  group by  C_CODE ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='1' group by C_CODE";
			}	
        }
         
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='0'  group by C_CODE";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='0'  group by C_CODE";
			}	
        }
	}
	...
	if ($_GET["cmbbrand"] != "All") {
        if ($_GET["cmbdev"] == "All") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'   group by C_CODE" ;
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'  group by C_CODE ";
        	}
		}
         
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "'   group by C_CODE";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "'  group by C_CODE";
			}	
        }
         
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' group by C_CODE";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where  GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='0'  and Brand='" . $_GET["cmbbrand"] . "'   group by C_CODE";
			}	
        }
	}
