...
//						echo "select Refno, Code, Amount   from s_crnfrm where Refno like  '%$letters%' and Cancell = '0' and Checked!='A' and Lock1='1' and Credit_note='A' and company = '" . $_SESSION["company"]. "' order BY Sdate  desc limit 50";  	
$sql = mysql_query("select Refno, Code, Amount   from s_crnfrm where Refno like  '%$letters%' and Cancell = '0' and Checked!='A' and Lock1='1' and Credit_note='A'  and company = '" . $_SESSION["company"]. "' order BY Sdate  desc limit 50") or die(mysql_error());
						...
						if ($_GET["mstatus"]=="invno"){ 
						  ...
						  if ($_SESSION["slected"]=="all"){
						  	$sql = mysql_query("select Refno, Code, Amount   from s_crnfrm where Refno like  '%$letters%' and cancell = '0' and flag = 'ACRN'  and company = '" . $_SESSION["company"]. "' order BY Refno desc limit 50") or die(mysql_error());
							
						  } else if ($_SESSION["slected"]=="locked"){
						  	$sql = mysql_query("select Refno, Code, Amount   from s_crnfrm where Refno like  '%$letters%' cancell = '0' and Lock1='1' and flag = 'ACRN'  and company = '" . $_SESSION["company"]. "' order BY Refno desc limit 50") or die(mysql_error());
							
		
						  } else if ($_SESSION["slected"]=="pending"){
						  	$sql = mysql_query("select Refno, Code, Amount   from s_crnfrm where Refno like  '%$letters%' cancell = '0' and Lock1='0' and flag = 'ACRN'  and company = '" . $_SESSION["company"]. "' order BY Refno desc limit 50") or die(mysql_error());
...
if ($_GET["Command"]=="invno_check_crn"){
	...
	//echo $sql_stsql;
    $result_stsql =$db->RunQuery($sql_stsql);
	if ($row_rssalma = mysql_fetch_array($result_stsql)) {
    ...
    $result_crnfrm =$db->RunQuery($sql_crnfrm);
