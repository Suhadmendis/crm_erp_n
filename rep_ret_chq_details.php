        ...
        <table width="767" border="0">
            <tr>
                <td align="left"><input type="radio" name="radio" id="optunsettle" value="optunsettle" checked="checked" /> 
                    Unsettled</td>
                <td align="left" style="visibility:hidden;"><input type="radio" name="radio" id="optall" value="optall" /> 
                    All</td>
                <td align="left">&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            return false" onfocus="this.blur()"><input type="text" name="cusname" id="cusname" class="text_purchase3"/>
                ...
                <td width="44"><a href="serach_customer.php?stname=rep_outstand_state" onclick="NewWindow(this.href, 'mywin', '800', '700', 'yes', 'center');
            ...
            <tr>
                <td colspan="3" align="left" style="visibility:hidden;"><table width="400" border="0">
                        <tr>
            ...
            <tr>
                <td colspan="2" align="left">&nbsp;</td>
                <td align="left" style="visibility:hidden;"><input type="checkbox" name="detailed" id="detailed" checked="checked"/>Print Friendly</td>
