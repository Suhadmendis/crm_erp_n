...
<html lang="en">
    <head>
        <title>Market Segment Master File</title>
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>Market Segment Master File</b></h3>
                        </div>
                        <form name= "form1" role="form" class="form-horizontal">
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group-sm">
                                        <label class="col-sm-1 input-sm" style="text-align:  left; background-color: #5A687B;  color: white;" for="invno">Market Segment Code</label>
                                        <div class="col-sm-1">
                                            <input type="text" placeholder="Reference " id="referenceTxt" class="form-control  input-sm ">
                                        </div> 
                                    ...
                                    <div class="form-group-sm" >
                                        <label class="col-sm-1 input-sm labelColour" style="text-align: left; background-color:#5A687B; margin-top: -12px;" for="invno">Market Segment Name</label>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Type Name" id="typeNameTxt" class="form-control  input-sm labelColour">
                                        </div>  
