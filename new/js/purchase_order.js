...
function newent() {
    ...
    document.getElementById('manual_txt').value = "";
    document.getElementById('uniq').value = "";
    document.getElementById('jobno_txt').value = "";
    document.getElementById('date_txt').value = "";
    document.getElementById('currencycode_txt').value = "";
    document.getElementById('exchangerate_txt').value = "";
    document.getElementById('supplier_no').value = "";
    document.getElementById('costcenter_txt').value = "";
    document.getElementById('remarks_txt').value = "";
    document.getElementById('tcomb_txt').value = "";
...
function getdt() {
    ...
    var url = "purchase_order_data.php";
...
//    if (document.getElementById('manual_txt').value == "") {
...
//    }
    ...
    url = url + "&manual_txt=" + document.getElementById('manual_txt').value;
    ...
    url = url + "&exchangerate_txt=" + document.getElementById('exchangerate_txt').value;
    url = url + "&supplier_no=" + document.getElementById('supplier_no').value;
...
//    url = url + "&aodnumber=" + mid;
    url = url + "&refno_txt=" + document.getElementById('refno_txt').value;
    url = url + "&recordno=" + document.getElementById('recordno').value;
    url = url + "&p_discription=" + document.getElementById('p_discription').value;
    url = url + "&p_quantity=" + document.getElementById('p_quantity').value;
    url = url + "&p_price=" + document.getElementById('p_price').value;
    url = url + "&p_discount=" + document.getElementById('p_discount').value;
    url = url + "&p_value=" + document.getElementById('p_value').value;
    url = url + "&p_tccode=" + document.getElementById('p_tccode').value;
...
function aodtmp() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
        ...
        document.getElementById('p_discription').value;
        ...
        document.getElementById('p_tccode').value;
