...
function chk_ad(chk_name, cuscode)
{
	...
	xmlHttp=GetXmlHttpObject();
			...
			var url="dealer_incentive_report_data.php";			
...
function view()
{
	...
	//var ans=confirm("Block Modifications");
			...
			var url="dealer_incentive_report_data_2.php";			
			...
			url=url+"&DTPicker3="+document.getElementById('DTPicker3').value;
...
function print_advance(){
	...
	var url="report_dealer_incen_rep_2.php";		
	url=url+"?DTPicker1="+document.getElementById('DTPicker1').value;
	url=url+"?DTPicker2="+document.getElementById('DTPicker2').value;
	url=url+"?DTPicker3="+document.getElementById('DTPicker3').value;
