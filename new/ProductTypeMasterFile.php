...
<html lang="en">
    <head>
        <title>Product Type Master File</title>
                ...
                <section class="content">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><b>Product Type Master File</b></h3>
                        </div>
                        <form name= "form1" role="form" class="form-horizontal">
                            ...
                            <div class="box-body">
                               ...
                               <input type="hidden" id="tmpno" class="form-control">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group-sm">
                                         <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Type Code</label>
                                         <div class="col-sm-2">
                                            <input type="text" placeholder="Type Code" id="typeCodeTxt" class="form-control  input-sm">
                                        </div>                                        
                                    </div>
                                    <div class="form-group"></div>
                                    <div class="form-group-sm">
                                         <label class="col-sm-2 input-sm labelColour" style="text-align: left; background-color: #b3d1ff;" for="invno">Type Name</label>
                                         <div class="col-sm-6">
