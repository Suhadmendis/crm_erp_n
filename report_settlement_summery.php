    ...
    <body>
        ...
        function inv_sales() {
                ...
                if ($_GET["chkcus"] == "on") {
                    if (trim($_GET["cmbrep"]) == "All") {
                        ...
                        if ($_GET["cmbdev"] == "Manual") {
                            $sql = "SELECT * from view_salma_sttr where  C_CODE='" . trim($_GET["cuscode"]) . "' and (SDATE='" . $_GET["dtfrom"] . "' or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "' or SDATE<'" . $_GET["dtto"] . "') and DiV1='1' order by CUS_NAME";
                        }
                        if ($_GET["cmbdev"] == "Computer") {
                            $sql = "SELECT * from view_salma_sttr where  C_CODE='" . trim($_GET["cuscode"]) . "' and (SDATE='" . $_GET["dtfrom"] . "' or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and DiV1='0' order by CUS_NAME";
                        }
                    } else {
                        if ($_GET["cmbdev"] == "All") {
                            $sql = "SELECT * from view_salma_sttr where C_CODE='" . trim($_GET["cuscode"]) . "' and (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "' or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Manual") {
                            $sql = "SELECT * from view_salma_sttr where  C_CODE='" . trim($_GET["cuscode"]) . "' and (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " and DiV1='1' order by CUS_NAME";
                        }
                        if ($_GET["cmbdev"] == "Computer") {
                            $sql = "SELECT * from view_salma_sttr where  C_CODE='" . trim($_GET["cuscode"]) . "' and (SDATE='" . $_GET["dtfrom"] . "' or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "' or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " and DiV1='0' order by CUS_NAME ";
                        }
                    ...
                    if (trim($_GET["cmbrep"]) == "All") {
                        if ($_GET["cmbdev"] == "All") {
                            $sql = "SELECT * from view_salma_sttr where (SDATE='" . $_GET["dtfrom"] . "' or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Manual") {
                            $sql = "SELECT * from view_salma_sttr where (SDATE='" . $_GET["dtfrom"] . "' or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and DiV1='1' order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Computer") {
                            $sql = "SELECT * from view_salma_sttr where (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and DiV1='0' order by CUS_NAME ";
                        }
                    } else {
                        if ($_GET["cmbdev"] == "All") {
                            $sql = "SELECT * from view_salma_sttr where (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Manual") {
                            $sql = "SELECT * from view_salma_sttr where (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " and DiV1='1' order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Computer") {
                            $sql = "SELECT * from view_salma_sttr where (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " and DiV1='0' order by CUS_NAME ";
                        }
                        $txtrep = "Sales Rep : " + trim($_GET["cmbrep"]);
                    }
                }
            ...
            if ($_GET["cmbbrand"] != "All") {
                if ($_GET["chkcus"] == "on") {
                    if (trim($_GET["cmbrep"]) == "All") {
                        if ($_GET["cmbdev"] == "All") {
                            $sql = "SELECT * from view_salma_sttr where Brand='" . $_GET["cmbbrand"] . "' and  C_CODE= '" . trim($_GET["cuscode"]) . "'  and (SDATE='" . $_GET["dtfrom"] . "' or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "' or SDATE<'" . $_GET["dtto"] . "') order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Manual") {
                            $sql = "SELECT * from view_salma_sttr where  Brand='" . $_GET["cmbbrand"] . "' and  C_CODE='" . trim($_GET["cuscode"]) . "' and (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and DiV1='1' order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Computer") {
                            $sql = "SELECT * from view_salma_sttr where  Brand='" . $_GET["cmbbrand"] . "' and  C_CODE='" . trim($_GET["cuscode"]) . "' and (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and DiV1='0' order by CUS_NAME ";
                        }
                    } else {
                        if ($_GET["cmbdev"] == "All") {
                            $sql = "SELECT * from view_salma_sttr where  Brand='" . $_GET["cmbbrand"] . "' and C_CODE='" . trim($_GET["cuscode"]) . "' and (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Manual") {
                            $sql = "SELECT * from view_salma_sttr where  Brand='" . $_GET["cmbbrand"] . "' and  C_CODE='" . trim($_GET["cuscode"]) . "' and (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " and DiV1='1' order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Computer") {
                            $sql = "SELECT * from view_salma_sttr where  Brand='" . $_GET["cmbbrand"] . "' and  C_CODE='" . trim($_GET["cuscode"]) . "' and (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " and DiV1='0' order by CUS_NAME ";
                        }
                        $txtrep = "Sales Rep : " + trim($_GET["cmbrep"]);
                    }
                } else {
                    if (trim($_GET["cmbrep"]) == "All") {
                        if ($_GET["cmbdev"] == "All") {
                            $sql = "SELECT * from view_salma_sttr where Brand='" . $_GET["cmbbrand"] . "' and  (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Manual") {
                            $sql = "SELECT * from view_salma_sttr where  Brand='" . $_GET["cmbbrand"] . "' and (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and DiV1='1' order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Computer") {
                            $sql = "SELECT * from view_salma_sttr where  Brand='" . $_GET["cmbbrand"] . "' and (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and DiV1='0' order by CUS_NAME ";
                        }
                    } else {
                        if ($_GET["cmbdev"] == "All") {
                            $sql = "SELECT * from view_salma_sttr where Brand='" . $_GET["cmbbrand"] . "' and  (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Manual") {
                            $sql = "SELECT * from view_salma_sttr where  Brand='" . $_GET["cmbbrand"] . "' and (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " and DiV1='1' order by CUS_NAME ";
                        }
                        if ($_GET["cmbdev"] == "Computer") {
                            $sql = "SELECT * from view_salma_sttr where  Brand='" . $_GET["cmbbrand"] . "' and (SDATE='" . $_GET["dtfrom"] . "'or SDATE>'" . $_GET["dtfrom"] . "') and  (SDATE='" . $_GET["dtto"] . "'or SDATE<'" . $_GET["dtto"] . "') and SAL_EX = " . $repcode . " and DiV1='0' order by CUS_NAME ";
                        }
                        $txtrep = "Sales Rep : " + trim($_GET["cmbrep"]);
                    }
                }
            ...
            echo "<center><table width=800 border=1><tr>
		<th>Inv.Date</th>
		<th>Del.Date</th>
		<th>Inv.No</th>
		<th>Customer</th>
		...
		<th>Uti/J.Entry</th>
			...
			<td>" . $row["ST_CHNO"] . "</td>";
                    ...
                    if ((($row["pay_type"] == 'C/TT') or ( $row["ST_CHNO"] == 'Cash')) and ( $row["pay_type"] != 'J/Entry')) {
        ...
        function invRec() {
            ...
            $sql = $sql . " order by CUS_NAME,SDATE, ST_INVONO";
...
////////////////////////////
		...
		if ($_GET["cmbtype"]=="All"){	
            while ($row = mysql_fetch_array($result)) {
				...
				<td>" . $row["ST_INVONO"] . "</td>";
                        ...
                        echo "<td>" . substr(trim($row["CUS_NAME"]), 0, 18) . "</td>
				<td align=\"right\">" . $row["GRAND_TOT"] . "</td>";

                        $due = $row["GRAND_TOT"] - $row["TOTPAY"];
                        if (($due > 0) or ( $due < 0)) {
                            echo "<td align=\"right\">" . number_format($due, 2, ".", ",") . "</td>";
                        } else {
                            echo "<td align=\"right\"></td>";
                        }
			...
			<td>" . $row["ST_CHNO"] . "</td>";
                ...
                if ($row["ST_CHNO"] != "Cash TT") {
                    if ($row["st_chdate"] != "0000-00-00") {
                        echo "<td>" . $row["st_chdate"] . "</td>";
                        echo "<td>" . substr($row["st_chbank"], 0, 3) . "</td>";
                    } else {
                        echo "<td></td>";
                        echo "<td></td>";
                    }
                ...
                if ((($row["pay_type"] == 'C/TT') or ( $row["pay_type"] == 'Cash TT') or ( $row["ST_CHNO"] == 'Cash'))) {
		...
		} else if ($_GET["cmbtype"]=="Cheque/Cash"){	
              
			while ($row = mysql_fetch_array($result)) {
			  
			  if (($row["ST_CHNO"] == "Cash TT")   or ($row["ST_CHNO"] == "Cash") or (is_numeric(substr($row["ST_CHNO"], 0, 6)) == true)) {
                if ($ST_INVONO != $row["ST_INVONO"]) {
 ...
 //( $row["ST_CHNO"] != 'Cash') and
                if (($row["ST_FLAG"] == 'CHK') and  ( $row["pay_type"] != 'J/Entry')) {   
                    echo "<td align=\"right\">" . $row["ST_PAID"] . "</td>";
                    $chk = $chk + $row["ST_PAID"];
                } else {
                    echo "<td></td>";
		...
		}	else if ($_GET["cmbtype"]=="Credit Note"){	
              
			while ($row = mysql_fetch_array($result)) {
			 
			  if ((substr($row["ST_REFNO"], 0, 4) == "CUTI")) {
                if ($ST_INVONO != $row["ST_INVONO"]) {
			...
			echo "<tr><td colspan=2></td><td colspan=8>&nbsp;</td><td colspan=2></td></tr>";		
			echo "<tr><td colspan=2>Prepared By</td><td colspan=8>&nbsp;</td><td colspan=2>Authorized By</td></tr>";		
            echo "<table>";
        }
        ...
        function invReT() {
            ...
            if ($_GET["chkcus"] == "on") {
                $sql = "SELECT * from view_ch_sttr where CR_C_CODE = '" . trim($_GET["cuscode"]) . "' and (ST_DATE='" . $_GET["dtfrom"] . "'or ST_DATE>'" . $_GET["dtfrom"] . "') and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "')  order by ST_DATE,CR_C_NAME ";
            } else {
                $sql = "SELECT * from view_ch_sttr where (ST_DATE='" . $_GET["dtfrom"] . "' or ST_DATE>'" . $_GET["dtfrom"] . "') and  (ST_DATE='" . $_GET["dtto"] . "'or ST_DATE<'" . $_GET["dtto"] . "') order by ST_DATE,CR_C_NAME ";
            }
            ...
            echo "<center><span class=\"style1\"></span></center><br>";
...
//////////// Scrap //////////////////////////////////////
		...
		<th>Net Amount</th>
			...
			<td align=\"right\"><b>" . number_format($totvat, 2, ".", ",") . "</b></td></tr>";
