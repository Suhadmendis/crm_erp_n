...
{   
			...
			document.getElementById('openGL').innerHTML="";
...
// 	console.log(typeof(parseFloat(document.getElementById(cash_pay).innerHTML)));
//  // alert(document.getElementById(overdue).value);
// // alert(cash_pay)
// // alert(getpay);;
// var temp = document.getElementById(cash_pay).value;
// console.log(temp);

//  	 // document.getElementById(getpay).innerHTML = document.getElementById(cash_pay).value || 0;
//  	 // console.log(document.getElementById(cash_pay).value);
  ...
  if (Number(overdue_v)>=Number(inv_tot_pay_all)) {  
	...
	over=Number(parseFloat(Math.round(document.getElementById("amount").value * 100) / 100).toFixed(2))+Number(parseFloat(Math.round(document.getElementById("chqtot").value * 100) / 100).toFixed(2));
	...
	/*	if (Number(document.getElementById(inv_balance_val).value)<0){
		...
		document.getElementById("amount").value=pay_tot;
...
/*	var j=1;
	...
	document.getElementById('amount').value=sel_inv_tot;
	document.getElementById('txtoverpay').value=(document.getElementById('amount').value+document.getElementById('chqtot').value)-sel_inv_tot;*/
...
function calc_bal_cash(overdue, cash_pay_next, chq_pay, inv_balance, cash_pay, gpay, e)
{	

	// console.log(overdue+":"+cash_pay_next+":"+chq_pay+":"+inv_balance+":"+cash_pay+":"+gpay+":"+e);
	...
	if ((isNaN(document.getElementById(cash_pay).value)==false) && (document.getElementById(cash_pay).value!="")){
		...
		document.getElementById(gpay).innerHTML = cash_pay_v;
		console.log(cash_pay_v);
 ...
 // if(e.keyCode==13){
	...
	over=Number(document.getElementById("amount").value)+Number(document.getElementById("chqtot").value);
	over_tmp=parseFloat(over);
	over=over_tmp.toFixed(2);
	while (mcou>=i){
	...
	over=Number(document.getElementById("amount").value);
	over_tmp=over;
	over=over_tmp.toFixed(2);
 ...
 if (Number(document.getElementById("amount").value) < Number(pay_cash)){
...
var XMLAddress1;
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
			...
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("accn1");
			var n1=XMLAddress1[0].childNodes[0].nodeValue;
			var a1=document.getElementById('amount').value;

			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("accn2");	
			var n2=XMLAddress1[0].childNodes[0].nodeValue;
			

			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("acc3");	
			var a3=XMLAddress1[0].childNodes[0].nodeValue;
			
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("acc4");	
			var a4=XMLAddress1[0].childNodes[0].nodeValue;


			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("accn3");	
			var n3=XMLAddress1[0].childNodes[0].nodeValue;
			
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("accn4");	
			var n4=XMLAddress1[0].childNodes[0].nodeValue;

		
	var table = "<table  border=1 width='800' style=\"font-size: 16px;\" >  <tr>    <th>Account</th>    <th>DEB</th>     <th>CRE</th>  </tr>";
 	
 	table = table + "<tr>    <td>"+n1+"</td>    <td>"+a1+"</td>     <td></td>  </tr>";

 	table = table + "<tr>   <td>"+n3+"</td>    <td></td>     <td></td>  </tr>";
 	table = table + "<tr>   <td>"+n4+"</td>    <td></td>    <td></td>     </tr>";

 	table = table + "<tr>    <td>"+n2+"</td>        <td></td> <td>"+a1+"</td>  </tr>";
  
	table = table + "</table>";


 	document.getElementById("openGL").innerHTML=table;
