...
if ($_GET["Command"] == "save_item") {
    ...
    try {
        ...
        $sql = "delete from qr where ref_no = '" . $_GET['referenceTxt'] . "'";
        $result = $conn->query($sql);



        $sql = "Insert into qr (ref_no,t_date,drf_no,req_date,cus_code,cus_name,mak_code,mak_name,attention,cc,pay_term,brand_code,brand_name,remarks)values 
    ('" . $_GET['ref_no'] . "', '" . $_GET['t_date'] . "', '" . $_GET['drf_no'] . "','" . $_GET['req_date'] . "','" . $_GET['cus_code'] . "', '" . $_GET['cus_name'] . "', '" . $_GET['mak_code'] . "','" . $_GET['mak_name'] . "','" . $_GET['attention'] . "', '" . $_GET['cc'] . "','" . $_GET['pay_term'] . "','" . $_GET['brand_code'] . "', '" . $_GET['brand_name'] . "','" . $_GET['remarks'] . "') ";
