...
function newent() {
    ...
    document.getElementById('proNameTxt').value = "";
    document.getElementById('proGroCodeTxt').value = "";
    document.getElementById('proGroNameTxt').value = "";
    document.getElementById('proTyCodeTxt').value = "";
    document.getElementById('proTyNameTxt').value = "";
    document.getElementById('taxComTxt').value = "";
    document.getElementById('proUomTxt').value = "";
    document.getElementById('reOrdLTxt').value = "";
    document.getElementById('reOrdQTxt').value = "";
    document.getElementById('lenTxt').value = "";
    document.getElementById('widTxt').value = "";
    document.getElementById('heiTxt').value = "";
    document.getElementById('lenInTxt').value = "";
    document.getElementById('widInTxt').value = "";
    document.getElementById('uomSizeTxt').value = "";
...
function save_inv() {
    ...
    if (document.getElementById('proCodeTxt').value == "") {
    ...
    if (document.getElementById('proNameTxt').value == "") {
    ...
    if (document.getElementById('proGroCodeTxt').value == "") {
    ...
    if (document.getElementById('proGroNameTxt').value == "") {
    ...
    if (document.getElementById('proTyCodeTxt').value == "") {
    ...
    if (document.getElementById('proTyNameTxt').value == "") {
    ...
    if (document.getElementById('taxComTxt').value == "") {
    ...
    if (document.getElementById('proUomTxt').value == "") {
