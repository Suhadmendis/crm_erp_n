...
if ($_GET["Command"] == "save_item") {
    ...
    try {
        ...
        $sql = "delete from overHead_Master where overh_code = '" . $_GET['o_code'] . "'";
        $result = $conn->query($sql);



        $sql = "Insert into overHead_Master (overh_code,overh_descript,rate,fixed_oh)values 
    ('" . $_GET['o_code'] . "', '" . $_GET['o_name'] . "', '" . $_GET['rate'] . "', '" . $_GET['check1'] . "') ";
