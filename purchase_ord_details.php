    ...
    <form name="form1" id="form1">            
        <table width="100%" border="0"  class=\"form-matrix-table\">
            <tr>
                ...
                <td width="10%"><input type="text"  class="label_purchase" value="Schedule Date" hidden="" disabled="disabled"/></td>
                <td width="10%"><input type="text" size="20" name="dte_shedule" id="dte_shedule" hidden="" value="" class="text_purchase3"/>
                    <script type="text/javascript">
                        window.onload = function () {
                            new JsDatePick({
                                useMode: 2,
            ...
            <tr>
                ...
                <td><input type="text"  class="label_purchase" value="IMP - Bank Ref" disabled/></td>
            ...
            <tr>
                ...
                <td><select name="brand" id="type" onkeypress="keyset('searchitem', event);" class="text_purchase3"  onchange="assignbrandsession();">
