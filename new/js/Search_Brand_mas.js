...
function getdt() {
    ...
    var url = "Search_Brand_mas_data.php";
...
function passcusresult_quot()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        opener.document.form1.brandCodeTxt.value = XMLAddress1[0].childNodes[0].nodeValue;


        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("name");
        opener.document.form1.brandNameTxt.value = XMLAddress1[0].childNodes[0].nodeValue;
...
function update_cust_list(stname)
{
    ...
    var url = "Search_Brand_mas_mas_data.php";
