...
<table width="1000"  border="0">
  <tr>
    <td height="50" colspan="3"><span class="style6"><?php echo $row_para["COMPANY"]; ?></span><br />
   ...
   if ($_GET["vat"]=="true"){
    ...
    <td colspan="4" align="center"><table width="500" border="0">
      <tr>
          <?php 
          if((substr($row["REF_NO"], 0, 2) == "RC")&&($row['SDATE']>='2017-04-08')){
              echo "<td width=\"402\"><span class=\"style8\">No. 205, Hewagama, Kaduwela</span></td>";
          }else{
              echo "<td width=\"402\"><span class=\"style8\">".$row_para["ADD1"].", ".$row_para["ADD2"].", " .$row_para["ADD3"] . "</span></td>";
          }
          ?>
  ...
  <tr>
    ...
    <td width="171" align="left">Sales Ex : <?php echo $row_salrep["Name"]; ?></td>
    <td width="80" align="right">Entered By: </td>
    <td width="186"><?php echo $row["use_name"]; ?></td>
  </tr>
  <tr>
    <td height="110" colspan="3" valign="top"><table border="1" bordercolor="#000000" cellpadding="0" cellspacing="0"><tr><td width="428"><table width="500" border="0" >
        <tr>
          ...
          <td width="443"><span class="style5"><?php  echo $rtxtSupName;  ?></span></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><?php  echo $txtadd1;  ?></td>
        </tr>
        <tr>
          <td height="21">&nbsp;</td>
          <td>&nbsp;</td>
          <td><?php  echo $txtadd2;  ?></td>
        </tr>
        <tr>
          <td height="21">&nbsp;</td>
          <td>&nbsp;</td>
    ...
    <td colspan="4" valign="top"><table border="1" bordercolor="#000000" cellpadding="0" cellspacing="0"><tr><td><table width="500" border="0">
      <tr>
        <td width="108"><span class="style4">INV. NO</span></td>
        <td width="9">:</td>
        <td width="146"><span class="style8"><?php echo $row["REF_NO"]; ?></span></td>
        <td width="82"><span class="style4">P. O. NO.</span></td>
        <td width="12">:</td>
        <td width="201"><?php echo $row["ORD_NO"]; ?></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td height="21"><span class="style4">INV. DATE</span></td>
        <td>:</td>
        <td><span class="style8"><?php echo $row["SDATE"]; ?></span></td>
        <td><span class="style4">VEH. NO.</span></td>
        <td>:</td>
        <td><?php echo $row["veheno"]; ?></td>
      </tr>
...
<table width="1000" height="21" border="0" cellspacing="0">
  ...
  <tr>
    <td width="100" align="left"><table border="1" width="100" cellspacing="0"><tr><td><span class="style4"><u>ITEM NO.</u></span></td></tr></table></td>
    <td width="480" align="left"><table border="1"  width="480" cellspacing="0"><tr><td><span class="style4"><u>DESCRIPTION</u></span></td></tr></table></td>
    <td width="50" align="right"><table border="1"  width="50" cellspacing="0"><tr><td align="right"><span class="style4"><u>QTY</u></span></td></tr></table></td>
    <td width="120" align="right"><table border="1"  width="120" cellspacing="0"><tr><td align="right"><span class="style4"><u>RATE</u></span></td></tr></table></td>
    <td width="50" align="right"><table border="1"  width="50" cellspacing="0"><tr><td><span class="style4"><u>DIS1%</u></span></td></tr></table></td>
     <td width="50" align="right"><table border="1"  width="50" cellspacing="0"><tr><td><span class="style4"><u>DIS2%</u></span></td></tr></table></td>
    <td width="100" align="right"><table border="1"  width="100" cellspacing="0"><tr><td align="right"><span class="style4"><u>AMOUNT</u></span></td></tr></table></td>
  </tr>
  <?php 
	  	$i=1;
		$totsuntot=0;
		...
		while ($row1 = mysql_fetch_array($result1)){
			...
			if (($VAT_per=="1") or ($VAT_per=="2")){
				...
				echo "<tr><td><span width=100  class=\"style10\">".$row1["STK_NO"]."</span></td>
						<td><span width=500  class=\"style10\">".$row1["DESCRIPT"]."</span></td>
						<td align=\"right\"  width=50><span  class=\"style10\">".number_format($row1["QTY"], 0, ".", ",")."</span></td>
						<td  align=\"right\"  width=100><span  class=\"style10\">".number_format($PRICE, 2, ".", ",")."</span></td>
						
						<td align=\"right\"  width=50><span  class=\"style10\">".floatval($row1["Print_dis1"])."</span></td>
						<td align=\"right\"  width=50><span  class=\"style10\">".floatval($row1["Print_dis2"])."</span></td>";
			
						$discount1=$PRICE*$row1["QTY"]*$row1["DIS_per"]/100;
						$subtot=($PRICE*$row1["QTY"])-$discount1;
				echo "<td align=\"right\"  width=100><span  class=\"style10\">&nbsp;&nbsp;&nbsp;&nbsp;".number_format($subtot, 2, ".", ",")."</span></td>";
...
<table width="1000" border="0">
  ...
  <tr>
    <td width="80">&nbsp;</td>
    <td colspan="3"><span class="style6"><?php echo $copy; ?></span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>
    <?php
  ...
  <tr>
    <td>__________</td>
    <td width="98">&nbsp;</td>
    <td width="96">____________</td>
    <td width="104">&nbsp;</td>
    <td>____________</td>
    <td></td>
    <td align="right">&nbsp;</td>
    <td align="right"><b>
      <span class="style7">      </span></b>
      <table width="250" border="0">
        <tr>
          <td width="175" align="right"><b><span class="style7">
  ...
  <tr>
    ...
    <td>Deliverd By</td>
    <td></td>
    <td align="right">Printed By:<?php echo $_SESSION["CURRENT_USER"]; ?> </td>
    <td align="right"></td>
  </tr>
  <tr>
    <td colspan="4"><?php
