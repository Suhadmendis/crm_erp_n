...
<!--                    <a onclick="edit();" class="btn btn-warning btn-sm ">
                    ...
                    <a onfocus="this.blur()" onclick="NewWindow('search_purchase_path.php?stname=POSER', 'mywin', '800', '700', 'yes', 'center');
                            return false" href="">
<!--                                            <input type="button" class="btn btn-default "  id="searchcust" name="searchcust">-->
                ...
                <div class="col-md-12">
                    ...
                    <div class=""></div>
                    <label class="col-sm-1" for="c_code">PO Requisition</label>
                    <div class="col-sm-2">
                        <input type="text" placeholder=""  id="po_requisition" class="form-control  input-sm">
                    </div>
                    <div class="col-sm-1"></div>
                    <div class="col-sm-2">
...
<script src="js/purchase_order_entry.js"></script>
<!--<script>add_tmp();></script>-->
