...
function getdt() {
    ...
    var url = "good_return_note_entry_data.php";
...
function delete1() {
    ...
    if (document.getElementById('reference_no').value == "") {
        document.getElementById('msg_box').innerHTML = "<div class='alert alert-danger' role='alert'><span class='center-block'>Manual No  Not Entered</span></div>";
        return false;
    }
...
function add_tmp() {
    ...
    url = url + "&grn_no=" + document.getElementById('grn_no').value;
