...
function save_inv(inv_status)
{
    ...
    var accno3=document.getElementById('accno3').value;
    
    if ((accno2 == "")||(accno3 == "")){
        alert ("Please select GL posting!");
        return;
    }
    ...
    if (document.getElementById('invno').value != "") {
        ...
        params = params + "&accno2=" + accno2;
        params = params + "&accno3=" + accno3;
...
function new_inv()
{
    ...
    document.getElementById('accno3').value = "";
    document.getElementById('acc_name3').value = "";
...
function update_list(stname)
{
    ...
    var url = "search_arn_data_1_1.php";
