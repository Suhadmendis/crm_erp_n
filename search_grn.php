    ...
    <td width="346"  background="images/headingbg.gif" ><input type="text" size="50" name="invdate" id="invdate" value="" class="txtbox"/></td>
                ...
                <div class="CSSTableGenerator" id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
							...
							if (($_SESSION['COMCODE']=="A") or ($_SESSION['COMCODE']=="B") or ($_SESSION['COMCODE']=="R")){
								$sql="SELECT * FROM s_crnma where $phrase company='".$_SESSION['COMCODE']."' order by SDATE desc limit 50";
							} else {
                                                                if($stname == "caj"){
                                                                    $phrase = "where REF_NO LIKE 'CAJ%'";
                                                                }
								$sql="SELECT * FROM s_crnma $phrase order by SDATE desc limit 50";
							}	
//							echo $sql;
