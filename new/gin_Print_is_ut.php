...
$html .="<body> 
        ...
        <table   style='width: 660px;' class='table1'>
            ...
            <tr>
             ...
             <tr>
                <th colspan='3' class='bottom head'><center>General Issue Utilization Note</th>
             </tr>
...
$html .="</tr>
            <tr>
                <td>From</td>
                <td>".$row['DEP_F_NAME']."</td>
            </tr>
            <tr>
                <td>To</td>
                <td>".$row['DEP_T_NAME']."</td>
            </tr>
            <tr>
                <td>Reference #</td>
                <td>".$row['REF_NO']."</td>
        ...
        <table border=1 style='width: 660px;' class='table1'>
            <tr>
                ...
                <th style='width: 400px;'>Invoice Number</th>
...
$i = 1;
//$mnet = 0;
$sql = "Select * from s_trn where REFNO='" . $row["REF_NO"] . "' and LEDINDI = 'GINU'";
...
$html .="</table>
        ...
        <table style='width: 660px;' class='table1'>
            ...
            <tr>
                ...
                <td align='right'>Date of General Issue Utilization Note</td>
