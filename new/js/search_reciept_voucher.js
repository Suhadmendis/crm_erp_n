...
function getdt() {
    ...
    var url = "search_reciept_voucher_data.php";
...
function passcusresult_quot()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        opener.document.getElementById('receipt_ref').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        opener.document.getElementById('receipt_cash_book').value = XMLAddress1[0].childNodes[0].nodeValue;
        
          XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_customername3h");
        opener.document.getElementById('txt_gl_name').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        opener.document.getElementById('receipt_type').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        opener.document.getElementById('total_amount_of_receipt').value = XMLAddress1[0].childNodes[0].nodeValue;
