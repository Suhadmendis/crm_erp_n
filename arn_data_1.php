...
TYPE, brand) values ('" . $_POST["invno"] . "', '" . $_POST["invdate"] . "', '" . $_POST["orderno1"] . "', '" . $_POST["lc_no"] . "', '" . $_POST["pi_no"] . "', '" . $_POST["country"] . "', '" . $_POST["supplier_code"] . "', '" . $supplier_name . "', '" . $_POST["textarea"] . "', '" . $_POST["department"] . "', '" . $_POST["total_value"] . "', '" . $_POST["dte_dor"] . "', '" . $_POST["purtype"] . "', '" . $_POST["brand"] . "')";
        ...
        $sqlLedger = "Insert into ledger(l_refno, l_date, l_code, l_amount, l_flag, l_flag1, acyear) Values ('" . $_POST["invno"] . "', '" . $_POST["invdate"] . "', '" . $rowGlPost["l_code"] . "', " . $_POST["total_value"] . ", 'ARN', '" . $rowGlPost["entry_flag"] . "', '$ayear')";
        ...
        $sqlLedger = "Insert into ledger(l_refno, l_date, l_code, l_amount, l_flag, l_flag1, acyear) Values ('" . $_POST["invno"] . "', '" . $_POST["invdate"] . "', '" . $rowGlPost["l_code"] . "', " . $mgrand_tot . ", 'ARN', '" . $rowGlPost["entry_flag"] . "', '$ayear')";
        $result1=mysql_query($sqlLedger, $dbinv);
