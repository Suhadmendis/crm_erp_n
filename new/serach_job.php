    ...
    <body>
        <div class="container">
            ...
            <div id="filt_table">  <table class="table table-bordered">
                    ...
                    if(($stname == "")||($stname == "pickJOB")||($stname == "pickJOB_mst")){
                    ...
                    if ($stname == "pickJOB_fg") {

                        $sql .= " and cancel='0' order by jobdate desc limit 50";
...
//                    echo $sql;
                    ...
                    if ($stname == "pickJOB_fg") {
                      foreach ($conn->query($sql) as $row) {
                          ...
                          echo "<tr>
                                <td onclick=\"crnview('$cuscode', '$stname');\">" . $row['jid'] . "</a></td>
                                <td onclick=\"crnview('$cuscode', '$stname');\">" . $row['jobdate'] . "</a></td>
                                <td onclick=\"crnview('$cuscode', '$stname');\">" . $row['ProductDescription'] . "</a></td>
                              </tr>";
                      }
                    }else{
                      foreach ($conn->query($sql) as $row) {
